...
ZONES: [
  ...
  { name: 'Creator Market (Muse)', owner: 'Iris', status: 'In Review', img: 'muse-scope-2', renders: [...gallery('muse-scope', 9)], drawings: [], scope: 'Muse client design (revised 8/14). Island + Sponsor. 1× Circular flooring 320sqm black/grey/white. Island: 12× 8sqm + 6× 16sqm + 4× 32sqm. 3× 75" TV, 5× 1m Std Counter, 3× Custom wood frame, 6× Custom column. Arm lights pending JT confirmation.', flag: 'Client design · 320sqm · arm light pending',
    req: ['1× Circular flooring — black/grey/white w/ text (320sqm)', '3× 75" TV w/ stand', '5× 1mW Std Counter', '3× Custom wood frame structure w/ base (open 5 sides, overhead crossbeam for fishing lines)', '3× PVC graphic on both sides', '6× Custom Column (Island)', '1× Vinyl sticker (Sponsor)', 'Arm lights — pending JT confirmation'] },
