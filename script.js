...
ZONES: [
  ...
  { name: 'Wayfinding System & Promotion Materials', owner: 'Ari', status: 'Approved', img: 'wayfinding-0825-1', renders: ['wayfinding-0825-1', 'wayfinding-render-2', 'wayfinding-render-3'], drawings: ['wayfinding-dwg-1'], scope: 'AMG provide. Stand ×5 (70×170cmH) + 100" TV ×2 w/ stand + Pop up ×3 (3×6.5ft).', flag: '', req: ['5× Stand — 70×170cmH', '2× 100" TV w/ stand', '3× Pop up — 3×6.5ft'] },
  ...
  { name: 'Supplier A200 — Block C', owner: 'Chris', status: 'Approved', img: 'zone-c-map-0825', renders: ['zone-c-map-0825'], drawings: [], scope: 'C-01 ~ C-14. 13×8m² + 1×14m² + 18m² 額外地毯 (C-13). Wooden backdrop (4×2.5mH) + 42" TV + stand + Media Player + Std Counter + Grey carpet + AMG provide shelf & L-bracket.', flag: '14 booths · 14 std counters · AMG shelf',
...
GRAPHICS: [
  ...
  { zone: 'Wayfinding System & Promotion Materials', items: [
    ...
    { item: 'ASK-ME-ANYTHING', size: '—', material: 'Vinyl', qty: 1, status: 'pending', thumb: '' },
    { item: 'VIP-LOUNGE', size: '—', material: 'Vinyl', qty: 1, status: 'pending', thumb: '' },
    { item: 'COCREATE-MATCH', size: '—', material: 'Vinyl', qty: 1, status: 'pending', thumb: '' },
    { item: 'ALIBABA-COCREATE-2026', size: '—', material: 'Vinyl', qty: 1, status: 'pending', thumb: '' },
    { item: 'SOURCING-HUB', size: '700×1700mm', material: 'Vinyl', qty: 1, status: 'pending', thumb: '' },
    { item: 'NATIONAL-PAVILION', size: '700×1700mm', material: 'Vinyl', qty: 1, status: 'pending', thumb: '' },
    { item: 'MAIN-FORUM', size: '700×1700mm', material: 'Vinyl', qty: 1, status: 'pending', thumb: '' },
  ]},
  { zone: 'Next Gen', items: [
  ...
  { zone: 'Supplier Block B', items: [
    ...
    { item: 'B-02-SIDE-L', size: '1962×2409mm', material: 'BO Fabric', qty: 1, status: 'approved', thumb: '' },
