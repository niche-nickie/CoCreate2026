...
const ZONE_CQ_TIER = [
  { key:'cq1', name:'CQ-1', sqm:'9m²', count:1, req: ['1× Std No Skin Panel — 3000W×2413H×500D','1× Std Counter — 990W×1000H×495D, Formica Black','1× 42" TV wall mount + Media Player','1× Fabric Graphic — 2966×2409mm, RX-101 Channel 9ft','Black+Orange Carpet'] },
  { key:'cq2', name:'CQ-2', sqm:'9m²', count:1, req: ['1× Std No Skin Panel — 3000W×2413H×500D','1× Std Counter — 990W×1000H×495D, Formica Black','1× 42" TV wall mount + Media Player','1× Fabric Graphic — 2966×2409mm, RX-101 Channel 9ft','Black+Orange Carpet'] },
  { key:'cq3', name:'CQ-3', sqm:'9m²', count:1, req: ['1× Std No Skin Panel — 3000W×2413H×500D','1× Std Counter — 990W×1000H×495D, Formica Black','1× 42" TV wall mount + Media Player','1× Fabric Graphic — 2966×2409mm, RX-101 Channel 9ft','Black+Orange Carpet'] },
...
ZONES: [
  ...
  { name: 'Chongqing Pavilion', owner: 'Iris', status: 'Approved', img: 'chongqing-map', renders: ['chongqing-map', 'chongqing-v2-2'], drawings: ['chongqing-dwg-3'], scope: 'AMG shop drawings A.2–A.4 (JP, RENT). 36m² (4× 9sqm). Central: LED Lighting Structure 1200mm dia×3450mm H + 36× LED strips + 4× Display Stands (BLK Formica). Perimeter: 3× Std No Skin Panels 990×2413 + 42" TV + stand + Media Player wall mount + Counter. Floor Trim 260ft.', flag: '4× 9sqm booths',
    req: ['4× Std No Skin Panel — 3000W×2413H×500D', '4× Std Counter — 990W×1000H×495D, Formica Black', '4× 42" TV wall mount + Media Player', '4× Fabric Graphic — 2966×2409mm, RX-101 Channel 36ft', '4× 9sqm Booths, Black+Orange Carpet'], tiers: ZONE_CQ_TIER, units: makeTieredUnits('cq', ZONE_CQ_TIER, i => BOOTH_LABELS.cq[i-1]) },
  { name: 'Sponsor Booths 15+1', owner: 'Jin & Chris', status: 'Approved', img: 'sponsor-booths-map', renders: ['sponsor-booths-map'], drawings: [], scope: 'AMG shop drawings A.2–A.5 (JP, RENT). 16 booths (P-01 ~ P-16): 8×8ft ×9, 10×10ft ×3, 10×15ft ×2, 10×20ft ×2 (P-05 空地, AMG 不提供).', flag: '15+1 booths · 1× 空地',
