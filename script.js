...
const IMG_CACHE_BUST = '?v=20260812n';  // bump to bust image CDN cache
...
const ZONE_E_TIER = [{ key:'booth', name:'Booth', sqm:'8m²', count:8, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] }];
const ZONE_F_TIER = [
...
ZONES: [
  ...
  { name: 'Supplier A200 — Block E', owner: 'Jin & Chris', status: 'In Review', img: 'zone-e-map', renders: ['zone-e-map'], drawings: [], scope: 'E-01 ~ E-08. 8× 8sqm. Wooden backdrop (4×2.5mH) + 42" TV + stand + Media Player + Std Counter + Grey carpet. A200 standard build.', flag: '8× 8sqm · 8 std counters',
    req: ['Wooden backdrop (4×2.5mH)', '42" TV + stand + Media Player', 'Std Counter', 'Grey carpet', 'Furniture (by Youngs)'], tiers: ZONE_E_TIER, units: makeTieredUnits('zone-e', ZONE_E_TIER, i => BOOTH_LABELS.e[i-1], n => [`zone-e-render-${n*2}`, `zone-e-render-${n*2-1}`]) },
