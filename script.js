...
const IMG_CACHE_BUST = '?v=20260812q';  // bump to bust image CDN cache
...
ZONES: [
  ...
  { name: 'Supplier Non-A200 — Block F', owner: 'Jin & Chris', status: 'In Review', img: 'zone-f-map', renders: ['zone-f-map'], drawings: [], scope: 'F-01 ~ F-21. 11×6m² + 8×8m² + 2×14m² = 158m². YOUNGS Pop Up. AMG provide counter + TV + lighting + bracket.', flag: '21 booths · 21 std counters · 11/8/2',
