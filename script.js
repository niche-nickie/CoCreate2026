...
ZONES: [
  ...
  { name: 'AMA / Influencer Hub', owner: 'Ari', status: 'Quoted', img: 'ama-hub-0731', renders: ['ama-hub-v2-1', 'ama-hub-v2-2'], drawings: ['ama-dwg-1'], scope: 'AMG shop drawing A.9 (VB, V0). Std panels + trainels (White Formica), 6× Custom LED Wall Frames, plywood stage skin (13 sheets) + white PVC cover, 4000×2500 LED wall (40 panels). Client: 4× arm chair (Youngs). Graphics: AMA-SHAPE-1/2/3 + AMA-LOGO vinyls · AVL: Johnathan', flag: 'Stage height — check LACC 30" rule',
  ...
  { name: 'Agentic Robotics Arena', owner: 'Ari', status: 'TBD', img: 'agentic-robotics-1', renders: ['agentic-robotics-2', 'agentic-robotics-3'], scope: 'Youngs proposal — all else by Youngs. Grey carpet + vinyl floor. AMG scope TBD.', flag: '🆕 New zone · Youngs design proposal', req: ['Grey carpet', 'Vinyl floor', 'All else — by Youngs'] },
  { name: 'Buyer Story', owner: 'Ari', status: 'Quoted', img: 'buyer-story-1', renders: [...gallery('buyer-story-v2', 5)], scope: 'Youngs provide structure. AMG build + 1× 42" TV + stand.', flag: '⚠ Youngs structure · AMG build + TV',
  ...
  { name: 'Sourcing Hub', owner: 'Iris', status: 'In Review', img: 'sourcing-hub', renders: ['sourcing-hub-v2-1', 'sourcing-hub-v2-2', 'sourcing-hub-v2-3', 'sourcing-hub-v2-4', 'sourcing-hub-v2-5', 'sourcing-hub-v2-6', 'sourcing-hub-v2-7'], drawings: ['sourcing-hub-dwg-1', 'sourcing-hub-dwg-2', 'sourcing-hub-dwg-3', 'sourcing-hub-dwg-4', 'sourcing-hub-dwg-5', 'sourcing-hub-dwg-6'], scope: 'AMG shop drawings A.2–A.7 (JP, RENT). 64m² (8×8m). Display Sign 1000×2000mm. 42" TV + stand. 4 centers: A 汕頭 (Stair Display), B 永康 (Display Stand+Acrylic), C 鄭州 (5× Display Stands), D 廣州 (Curved Display Stand 2000×1300). PVC graphics + floor vinyl per booth.', flag: '4 sourcing centers (9m² each) inside 64m² space',
