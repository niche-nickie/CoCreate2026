...
const IMG_CACHE_BUST = '?v=20260825g';  // bump to bust image CDN cache
...
ZONES: [
  { name: 'Registration', owner: 'Ari', status: 'Approved', img: 'registration-v2-2', renders: ['registration-0825-2', 'registration-0825-3'], drawings: ['registration-dwg-1', 'registration-dwg-2'], scope: 'AMG provide registration backdrop, front and back graphic.column graphics', flag: 'Lobby area',
  ...
  { name: 'Buyer Story', owner: 'Chris', status: 'Approved', img: 'buyer-story-v2-2', renders: ['buyer-story-0825-2', 'buyer-story-0825-3', 'buyer-story-0825-4', 'buyer-story-0825-5', 'buyer-story-0825-6'], scope: 'Youngs provide structure. AMG build + 1× 42" TV + stand + Media Player.', flag: '⚠ Youngs structure · AMG build + TV',
  ...
  { name: 'Supplier A200 — Block A', owner: 'Jin', status: 'Approved', img: 'zone-a-map-0825b', renders: ['zone-a-map-0825b'], drawings: [], scope: 'A-01 ~ A-09. 9× 8sqm. Wooden backdrop (4×2.5mH) + 42" TV + stand + Media Player + Std Counter + Grey carpet + AMG provide shelf & L-bracket.', flag: '9× 8sqm · 8 std counters · AMG shelf',
  ...
  { name: 'Supplier A200 — Block B', owner: 'Jin', status: 'Approved', img: 'zone-b-map-0825', renders: ['zone-b-map-0825'], drawings: [], scope: 'B-01 ~ B-07. 5×8m² + 1×12m² + 1×16m². Wooden backdrop (4×2.5mH) + 42" TV + stand + Media Player + Std Counter + Grey carpet. A200 standard build.', flag: '7 booths · 7 std counters · 5×8 + 12 + 16m²',
