...
ZONES: [
  ...
  { name: 'Buyer Story', status: 'In Review', img: 'buyer-story', gallery: ['buyer-story-2', 'buyer-story-3', 'buyer-story-4', 'buyer-story-5', 'buyer-story-6'], scope: 'Slot-together panel system — honeycomb paperboard (preferred), heavy-duty corrugated, or OSB (alternative). 2 layout options, each with TV', flag: 'New material system — confirm AMG capability',
