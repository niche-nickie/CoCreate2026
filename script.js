...
const IMG_CACHE_BUST = '?v=20260812y';  // bump to bust image CDN cache
...
const ZONE_ICONS = { 'Registration': '🏛', 'Core Display': '🔤', 'Keynote Hall': '🎤', 'AMA / Influencer Hub': '📷', 'Match Meeting': '🤝', 'Mini Panel': '🎙', 'Buyer Story': '📖', 'Unboxing Live': '📦', 'Next-Gen Sourcing + AI': '🤖', 'Podcast': '🎧', 'Chongqing Pavilion': '🏮', 'National Pavilion': '🌐', 'Sourcing Hub': '🔎', 'Sponsor Booths 13+1': '🏷', 'Supplier A200 — Block A': '🅰️', 'Supplier A200 — Block B': '🅱️', 'Supplier A200 — Block C': '©️', 'Supplier A200 — Block D': '🅳', 'Supplier A200 — Block E': '🅴', 'Supplier Non-A200 — Block F': '🅵', 'Supplier Non-A200 — Block G': '🅶', 'Muse Booth': '🎨', 'UED Booth': '💻', 'Creator Market': '🧵', 'Agentic Robotics Arena': '🦾' };
...
const SPONSOR_TIERS = [
  { key: 'community', name: 'Community', sqm: '6m²', count: 7, req: [
    ...
    'Counter w/ storage ×1 (990×1000×495mm, wooden joinery, matte white Formica, lockable)',
    'Electric socket ×1',
  ...
  { key: 'associate', name: 'Associate', sqm: '9m²', count: 2, req: [
    ...
    '42" TV + stand + Media Player ×1 set',
    'Counter w/ storage ×1 (990×1000×495mm)',
...
const ZONE_A_TIER = [
  { key:'a01', name:'A-01', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','9x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','26x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'a02', name:'A-02', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','4x) 900 (W)*18 (H)*400 (D), Shelf, Formica (WHT)','9x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','26x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'a03', name:'A-03', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','7x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','26x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'a04', name:'A-04', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','3x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','9x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','24x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture','2× Wire Grid 550×1100×50 (Youngs)'] },
  { key:'a05', name:'A-05', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','9x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','26x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'a06', name:'A-06', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','10x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','28x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'a07', name:'A-07', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','9x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','26x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'a08', name:'A-08', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*400 (D), Shelf, Formica (WHT)','11x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','30x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'a09', name:'A-09', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','3x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','9x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','27x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
];
const ZONE_B_TIER = [
  { key:'b01', name:'B-01', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'b02', name:'B-02', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'b03', name:'B-03', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'b04', name:'B-04', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'b05', name:'B-05', sqm:'16m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'b06', name:'B-06', sqm:'12m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'b07', name:'B-07', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
];
const ZONE_C_TIER = [
  { key:'c01', name:'C-01', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'c02', name:'C-02', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','10x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','20x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'c03', name:'C-03', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','2x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','4x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'c04', name:'C-04', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','2x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','6x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'c05', name:'C-05', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','5x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','15x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'c06', name:'C-06', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','8x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'c07', name:'C-07', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','6x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','18x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'c08', name:'C-08', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','2x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','14x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'c09', name:'C-09', sqm:'14m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','4× LED arm light','1x) Display Shelving — 1452W×1700H×440D, Curved, Formica (WHT)','— YOUNGS —','Furniture'] },
  { key:'c10', name:'C-10', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','12x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','1x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','27x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'c11', name:'C-11', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'c12', name:'C-12', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','5x) 1700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','20x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'c13', name:'C-13', sqm:'26m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','4× LED arm light','— YOUNGS —','Furniture'] },
];
const ZONE_D_TIER = [
  { key:'d01', name:'D-01', sqm:'14m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','4× LED arm light','2x) 900 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','3x) 1000 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','1x) 1950 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','14x) 10" Metal L-Bracket (WHT)','1x) Display Shelving — 1452W×1700H×440D, Curved, Formica (WHT)','— YOUNGS —','Furniture'] },
  { key:'d02', name:'D-02', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','1x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','1x) 900 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','1x) 1350 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','3x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','16x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'d03', name:'D-03', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','1x) 1350 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','3x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','12x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'d04', name:'D-04', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','3x) 1350 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','1x) 1800 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','13x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'d05', name:'D-05', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'d06', name:'D-06', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','1x) 1350 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','2x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','1x) 1800 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','13x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'d07', name:'D-07', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'d09', name:'D-09', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','7x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','4x) 900 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','22x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'d10', name:'D-10', sqm:'10m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','2x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','2x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','2x) 1400 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','16x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
];
const ZONE_E_TIER = [
  { key:'e01', name:'E-01', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','1x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','1x) 900 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','1x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','7x) 10" Metal L-Bracket (WHT)','1× 4\'-6" Clothes Rack','1× 5\'-0" Clothes Rack','— YOUNGS —','Furniture'] },
  { key:'e02', name:'E-02', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'e03', name:'E-03', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','8x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','24x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'e04', name:'E-04', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','6x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','12x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture','4× Wire Grid 550×1100×50 (Youngs)'] },
  { key:'e05', name:'E-05', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','2× 5\'-0" Clothes Rack','4× 12" Rod for Clothes, Wall Mount','— YOUNGS —','Furniture','1× Wire Grid 550×1100×50 (Youngs)'] },
  { key:'e06', name:'E-06', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','1x) Display Case — 1902W×2092H×150D, Formica (WHT)','— YOUNGS —','Furniture'] },
  { key:'e07', name:'E-07', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','2x) 900 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','3x) 1000 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','10x) 10" Metal L-Bracket (WHT)','11× Hat/Coat Hook','— YOUNGS —','Furniture'] },
  { key:'e08', name:'E-08', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','8x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','6x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','28x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
];
const ZONE_F_TIER = [
  { key:'sm', name:'Booth', sqm:'6m²', count:11, req: ['42" TV + stand + Media Player','Std Counter','Grey carpet','2× LED arm light','— YOUNGS —','Pop Up','Displays and shelvings'] },
  { key:'md', name:'Booth', sqm:'8m²', count:8, req: ['42" TV + stand + Media Player','Std Counter','Grey carpet','4× LED arm light','— YOUNGS —','Pop Up','Displays and shelvings'] },
  { key:'lg', name:'Booth', sqm:'14m²', count:2, req: ['42" TV + stand + Media Player','Std Counter','Grey carpet','4× LED arm light','— YOUNGS —','Pop Up','Displays and shelvings'] },
];
const ZONE_G_TIER = [
...
ZONES: [
  ...
  { name: 'AMA / Influencer Hub', owner: 'Ari', status: 'No quote needed', img: 'ama-hub-render-1', renders: ['ama-hub-render-1'], scope: 'YOUNGS X JOHNATHAN — Banner ×6, Stage, Furniture by Youngs', flag: 'YOUNGS X JOHNATHAN', req: [] },

  { name: 'Match Meeting', owner: 'Ari', status: 'In Review', img: 'match-meeting-render-1', renders: ['match-meeting-render-1', 'match-meeting-render-2'], scope: 'YOUNGS X JOHNATHAN — Furniture by Youngs', flag: 'AMG provide TV', req: ['3× 65" TV with stand'] },
  ...
  { name: 'Core Display', owner: 'Iris', status: 'No quote needed', img: 'core-display-v2-2', renders: ['core-display-v2-2'], scope: 'Youngs provide', flag: 'YOUNGS', req: [] },
  { name: 'Next-Gen Sourcing + AI', owner: 'Ari', status: 'In Review', img: 'nextgen-render-1', renders: ['nextgen-render-1', 'nextgen-render-2', 'nextgen-render-3', 'nextgen-render-4', 'nextgen-render-5', 'nextgen-render-6', 'nextgen-render-7'], scope: 'AMG: Hanging Banners, Std+Custom Wood Panels (double-sided graphic), Floor Vinyl ×3, Custom Wood Display ×4, PVC Cut-outs ×3, Banners ×2, Cut-outs ×5, Tilted Wood Platform, 55" TV ×13, 100" TV ×1, Black Custom Counters ×4, White Std Counter ×1, Orange Counters ×2, Tables & Stools, Custom Installation. JT: All Mac. All else by Youngs.', flag: '⚠ Scope received 8/11 — AMG+JT+Youngs', req: [] },
  { name: 'Buyer Story', owner: 'Ari', status: 'Approved', img: 'buyer-story-v2-2', renders: ['buyer-story-v2-2','buyer-story-v2-3','buyer-story-v2-4','buyer-story-v2-5'], scope: 'Youngs provide structure. AMG build + 1× 42" TV + stand + Media Player.', flag: '⚠ Youngs structure · AMG build + TV',
    req: ['Structure (by Youngs)', 'AMG build', '1× 42" TV + stand + Media Player'] },
  { name: 'Unboxing Live', owner: 'Ari', status: 'Approved', img: 'unboxing-live-render-1', renders: ['unboxing-live-render-1'], scope: 'R4 — Display block ×3, Double-sided Pop-up, 55" TV, Furniture by Youngs, Cheapest flooring option', flag: '⚠ R4 — Pop-up + Display blocks + TV', req: ['3× Display block', 'Double-sided Pop-up', '1× 55" TV w/ stand', 'Furniture by Youngs', 'Cheapest flooring option'] },
  { name: 'Supplier A200 — Block A', owner: 'Jin & Chris', status: 'Approved', img: 'zone-a-map', renders: ['zone-a-map'], drawings: [], scope: 'A-01 ~ A-09. 9× 8sqm. Wooden backdrop (4×2.5mH) + 42" TV + stand + Media Player + Std Counter + Grey carpet + AMG provide shelf & L-bracket.', flag: '9× 8sqm · 9 std counters · AMG shelf',
    req: ['9× Wooden backdrop (4×2.5mH)', '9× 42" TV + stand + Media Player', '9× Std Counter', '9× Grey carpet (≈792 sqft)', '18× LED arm light', '3× Metal Panel Footing', '— AMG Shelf —', '27× 700mm shelf, Formica (WHT) (23× @300D + 4× @400D A-08)', '4× 900mm shelf, Formica (WHT) (4× @400D A-02)', '3× 1500mm shelf, Formica (WHT)', '82× 450mm shelf, Formica (WHT)', '239× 10" Metal L-Bracket (WHT)', '— YOUNGS —', '9× Furniture', '2× Wire Grid 550×1100×50 (A-04 only)'], tiers: ZONE_A_TIER, units: makeTieredUnits('zone-a', ZONE_A_TIER, i => BOOTH_LABELS.a[i-1], n => [`zone-a-render-${n*2}`, `zone-a-render-${n*2-1}`]) },
  { name: 'Supplier A200 — Block B', owner: 'Jin & Chris', status: 'Approved', img: 'zone-b-map', renders: ['zone-b-map'], drawings: [], scope: 'B-01 ~ B-07. 5×8m² + 1×12m² + 1×16m². Wooden backdrop (4×2.5mH) + 42" TV + stand + Media Player + Std Counter + Grey carpet. A200 standard build.', flag: '7 booths · 7 std counters · 5×8 + 12 + 16m²',
    req: ['7× Wooden backdrop (4×2.5mH)', '7× 42" TV + stand + Media Player', '7× Std Counter', '7× Grey carpet (≈748 sqft)', '14× LED arm light', '4× Metal Panel Footing', '— YOUNGS —', '7× Furniture'], tiers: ZONE_B_TIER, units: makeTieredUnits('zone-b', ZONE_B_TIER, i => BOOTH_LABELS.b[i-1], n => [`zone-b-render-${n*2}`, `zone-b-render-${n*2-1}`]) },
  { name: 'Supplier A200 — Block C', owner: 'Jin & Chris', status: 'Approved', img: 'zone-c-map', renders: ['zone-c-map'], drawings: [], scope: 'C-01 ~ C-13. 11×8m² + 1×14m² + 1×26m². Wooden backdrop (4×2.5mH) + 42" TV + stand + Media Player + Std Counter + Grey carpet + AMG provide shelf & L-bracket.', flag: '13 booths · 13 std counters · AMG shelf',
    req: ['13× Wooden backdrop (4×2.5mH)', '13× 42" TV + stand + Media Player', '13× Std Counter', '13× Grey carpet (≈1408 sqft)', '30× LED arm light', '6× Metal Panel Footing', '— AMG Shelf —', '20× 700mm shelf, Formica (WHT)', '12× 450mm shelf, Formica (WHT)', '16× 1500mm shelf, Formica (WHT)', '5× 1700mm shelf, Formica (WHT)', '1× Display Shelving — 1452×1700×440, Curved, Formica (WHT) (C-09)', '132× 10" Metal L-Bracket (WHT)', '— YOUNGS —', '13× Furniture'], tiers: ZONE_C_TIER, units: makeTieredUnits('zone-c', ZONE_C_TIER, i => BOOTH_LABELS.c[i-1], n => [`zone-c-render-${n*2}`, `zone-c-render-${n*2-1}`]) },
  { name: 'Supplier A200 — Block D', owner: 'Jin & Chris', status: 'Approved', img: 'zone-d-map', renders: ['zone-d-map'], drawings: [], scope: 'D-01 ~ D-07, D-09 ~ D-10. 1×14m² + 7×8m² + 1×10m² = 80m². Wooden backdrop + TV + Std Counter + Grey carpet + AMG shelf & L-bracket.', flag: '9 booths · 9 std counters · AMG shelf (D-08 removed)',
    req: ['9× Wooden backdrop (4×2.5mH)', '9× 42" TV + stand + Media Player', '9× Std Counter', '9× Grey carpet (≈880 sqft)', '20× LED arm light', '3× Metal Panel Footing', '— AMG Shelf —', '3× 450mm shelf, Formica (WHT)', '9× 700mm shelf, Formica (WHT)', '7× 900mm shelf, Formica (WHT)', '3× 1000mm shelf, Formica (WHT)', '6× 1350mm shelf, Formica (WHT)', '8× 1500mm shelf, Formica (WHT)', '2× 1800mm shelf, Formica (WHT)', '2× 1400mm shelf, Formica (WHT)', '1× 1950mm shelf, Formica (WHT)', '1× Display Shelving — 1452×1700×440, Curved, Formica (WHT) (D-01)', '106× 10" Metal L-Bracket (WHT)', '— YOUNGS —', '9× Furniture'], tiers: ZONE_D_TIER, units: makeTieredUnits('zone-d', ZONE_D_TIER, i => BOOTH_LABELS.d[i-1], n => [`zone-d-render-${n*2}`, `zone-d-render-${n*2-1}`]) },
  { name: 'Supplier A200 — Block E', owner: 'Jin & Chris', status: 'Approved', img: 'zone-e-map', renders: ['zone-e-map'], drawings: [], scope: 'E-01 ~ E-08. 8× 8m². Wooden backdrop (4×2.5mH) + 42" TV + stand + Media Player + Std Counter + Grey carpet + AMG provide shelf & L-bracket.', flag: '8× 8m² · 8 std counters · AMG shelf',
    req: ['8× Wooden backdrop (4×2.5mH)', '8× 42" TV + stand + Media Player', '8× Std Counter', '8× Grey carpet (≈704 sqft)', '16× LED arm light', '4× Metal Panel Footing', '— AMG Shelf —', '17× 450mm shelf, Formica (WHT)', '16× 700mm shelf, Formica (WHT)', '3× 900mm shelf, Formica (WHT)', '3× 1000mm shelf, Formica (WHT)', '1× 1500mm shelf, Formica (WHT)', '1× Display Case — 1902×2092×150, Formica (WHT) (E-06)', '81× 10" Metal L-Bracket (WHT)', '4× Clothes Rack (1×4\'6" + 3×5\'0")', '4× 12" Rod for Clothes', '11× Hat/Coat Hook', '— YOUNGS —', '8× Furniture', '5× Wire Grid 550×1100×50'], tiers: ZONE_E_TIER, units: makeTieredUnits('zone-e', ZONE_E_TIER, i => BOOTH_LABELS.e[i-1], n => [`zone-e-render-${n*2}`, `zone-e-render-${n*2-1}`]) },
  { name: 'Supplier Non-A200 — Block F', owner: 'Jin & Chris', status: 'Approved', img: 'zone-f-map', renders: ['zone-f-map'], drawings: [], scope: 'F-01 ~ F-21. 11×6m² + 8×8m² + 2×14m² = 158m². YOUNGS Pop Up. AMG provide counter + TV + lighting + bracket.', flag: '21 booths · 21 std counters · 11/8/2',
    req: ['21× Std Counter — 990×1000×495, Formica (WHT), Lockable Door+Shelf', '21× 42" TV + Media Player + HDMI Cable + Floor Stand', '21× Grey carpet (≈1738 sqft)', '62× LED Arm Light', '26× Popup Bracket for PVC Graphic', '— YOUNGS —', 'Pop Up', 'Displays and shelvings'], tiers: ZONE_F_TIER, units: makeTieredUnits('zone-f', ZONE_F_TIER, i => BOOTH_LABELS.f[i-1], n => [`zone-f-render-${n*2}`, `zone-f-render-${n*2-1}`]) },
  { name: 'Supplier Non-A200 — Block G', owner: 'Jin & Chris', status: 'TBD', img: 'zone-g-map', renders: ['zone-g-map'], drawings: [], scope: 'G-01 ~ G-11. 9×6m² + 2×12m². YOUNGS Pop Up. AMG provide counter + TV + lighting + bracket.', flag: '11 booths · 11 std counters · 9/2',
    req: ['11× Std Counter — 990×1000×495, Formica (WHT), Lockable Door+Shelf', '11× 42" TV + Media Player + HDMI Cable + Floor Stand', '11× Grey carpet (≈858 sqft)', '26× LED Arm Light', '22× Popup Bracket for PVC Graphic', '— YOUNGS —', 'Pop Up', 'Displays and shelvings'], tiers: ZONE_G_TIER, units: makeTieredUnits('zone-g', ZONE_G_TIER, i => BOOTH_LABELS.g[i-1], n => [`zone-g-render-${n*2}`, `zone-g-render-${n*2-1}`]) },
  ...
  { name: 'Sponsor Booths 13+1', owner: 'Jin & Chris', status: 'Approved', img: 'sponsor-booths', renders: ['sponsor-booths-2', 'sponsor-booths-3', 'sponsor-booths-4', 'sponsor-booths-5'], drawings: ['sponsor-dwg-1', 'sponsor-dwg-2', 'sponsor-dwg-3', 'sponsor-dwg-4'], scope: 'AMG shop drawings A.2–A.5 (JP, RENT). 4 tiers: Community 6m²×7 (Std Counter + 2× LED), Associate 9m²×2 (+42" TV + stand + Media Player + 4× LED), Executive 15m²×2 (+6× LED), Premier 20m²×1 (L-shaped wall + Custom Counter + 42" wall-mount).', flag: '13+1 booths',
    req: ['13× Std Counter — 990×1000×495, Formica (WHT)', '1× Custom Counter (Premier, wooden joinery)', '13× 42" TV + stand + Media Player', '1× 42" TV wall mount + Media Player (Premier)', 'LED arm light (數量 TBD)', '— YOUNGS —', 'Furniture + fabric display'],
    tiers: SPONSOR_TIERS,
  ...
  { name: 'Creator Market (Muse)', owner: 'Iris', status: 'In Review', img: 'muse-scope-2', renders: [...gallery('muse-scope', 9)], drawings: [], scope: 'Muse client design (revised 8/14) · Island + Sponsor. 1× Circular flooring 320sqm. 3× 75" TV. 5× 1m Wide Std Counter. 3× Custom wood frame. 3× PVC graphic. 6× Custom column. 1× Vinyl sticker. Arm lights — pending JT.', flag: 'Client design · 22 booths (12× 8sqm + 6× 16sqm + 4× 32sqm) · arm light pending',
    req: ['1× Circular flooring — black/grey/white w/ text (320sqm)', '3× 75" TV w/ stand', '5× 1m Wide Std Counter', '3× Custom wood frame structure w/ base (open 5 sides, overhead crossbeam for fishing lines)', '3× PVC graphic on both sides', '6× Custom Column (Island)', '1× Vinyl sticker (Sponsor)', 'Arm lights — pending JT confirmation'] },
