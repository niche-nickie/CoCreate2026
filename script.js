...
ZONES: [
  ...
  { name: 'Creator Market (Muse)', owner: 'Iris', status: 'In Review', img: 'muse-scope-2', renders: [...gallery('muse-scope', 9)], drawings: [], scope: 'Muse client design (revised 8/14). Island + Sponsor. Circular flooring 320sqm black/grey/white. Island: 8sqm×12 + 16sqm×6 + 32sqm×4. 75" TV ×3, 1m Std Counter ×5, Custom wood frame ×3, Custom column ×6. Arm lights pending JT confirmation.', flag: 'Client design · 320sqm · arm light pending',
    req: ['Circular flooring — black/grey/white w/ text (320sqm)', '75" TV w/ stand ×3', '1mW Std Counter ×5', 'Custom wood frame structure w/ base ×3 (open 5 sides, overhead crossbeam for fishing lines)', 'PVC graphic on both sides ×3', 'Custom Column ×6 (Island)', 'Vinyl sticker (Sponsor)', 'Arm lights — pending JT confirmation'] },
