...
const IMG_CACHE_BUST = '?v=20260812l';  // bump to bust image CDN cache
...
ZONES: [
  ...
  { name: 'Supplier A200 — Block D', owner: 'Jin & Chris', status: 'In Review', img: 'zone-d-map', renders: ['zone-d-map'], drawings: [], scope: 'D-01 ~ D-10. 1×14m² + 8×8m² + 1×10m². Wooden backdrop (4×2.5mH) + 42" TV + stand + Media Player + Std Counter + Grey carpet + AMG provide shelf & L-bracket.', flag: '10 booths · 10 std counters · AMG shelf',
    req: ['10× Wooden backdrop (4×2.5mH)', '10× 42" TV + stand + Media Player', '10× Std Counter', '10× Grey carpet (≈947 sqft)', '22× LED arm light', '— AMG Shelf —', '9× 450mm shelf, Formica (WHT)', '9× 700mm shelf, Formica (WHT)', '7× 900mm shelf, Formica (WHT)', '3× 1000mm shelf, Formica (WHT)', '5× 1350mm shelf, Formica (WHT)', '7× 1500mm shelf, Formica (WHT)', '3× 1800mm shelf, Formica (WHT)', '1× 1950mm shelf, Formica (WHT)', '108× 10" Metal L-Bracket (WHT)', '— YOUNGS —', '10× Furniture'], tiers: ZONE_D_TIER, units: makeTieredUnits('zone-d', ZONE_D_TIER, i => BOOTH_LABELS.d[i-1], n => [`zone-d-render-${n*2}`, `zone-d-render-${n*2-1}`]) },
