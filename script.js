...
const SPONSOR_ASSOCIATE_REQ = ['1× Std Counter — 990W×1000H×495D, Formica White', '1× 43" TV + stand + Media Player', '4× LED arm light', 'Grey carpet', '— YOUNGS —', 'Pop-up display (3500×2500mm)', 'High table + bar stools ×1 set', 'Furniture + fabric display'];
const SPONSOR_EXECUTIVE_REQ = ['1× Std Counter — 990W×1000H×495D, Formica White', '1× 43" TV + stand + Media Player', '6× LED arm light', 'Grey carpet', '— YOUNGS —', 'L-shaped pop-up display (5000×2500mm + 3000×2500mm)', 'High table + bar stools ×2 sets', 'Furniture + fabric display'];
const SPONSOR_PREMIER_REQ = ['1× Custom Counter — 1800W×500H×1000D, wooden joinery', '1× 43" TV wall mount + Media Player', '7× LED arm light', 'Grey carpet', 'L-shaped wall structure (5000×2500mm + 4000×2500mm)', '2× Full-height wall graphic, front only', '— YOUNGS —', 'Round meeting table + chairs ×2 sets', 'Furniture'];
...
const ZONE_A_TIER = [
  { key:'a01', name:'A-01', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','9x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','26x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'a02', name:'A-02', sqm:'8m²', count:1, renders: ['zone-a-render-9', 'zone-a-render-10'], req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','9x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','26x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'a03', name:'A-03', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','7x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','26x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'a04', name:'A-04', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','3x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','9x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','24x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture','2× Wire Grid 550×1100×50 (Youngs)'] },
  { key:'a05', name:'A-05', sqm:'8m²', count:1, renders: [], req: ['Grey carpet'] },
  { key:'a06', name:'A-06', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','10x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','28x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'a07', name:'A-07', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','9x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','26x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'a08', name:'A-08', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*400 (D), Shelf, Formica (WHT)','11x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','30x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'a09', name:'A-09', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','3x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','9x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','27x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
];
const ZONE_B_TIER = [
  { key:'b01', name:'B-01', sqm:'8m²', count:1, renders: ['zone-b-render-13', 'zone-b-render-14'], req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'b02', name:'B-02', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'b03', name:'B-03', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'b04', name:'B-04', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'b05', name:'B-05', sqm:'16m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'b06', name:'B-06', sqm:'12m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'b07', name:'B-07', sqm:'8m²', count:1, renders: ['zone-b-render-1', 'zone-b-render-2'], req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
];
const ZONE_C_TIER = [
  { key:'c01', name:'C-01', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'c02', name:'C-02', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','10x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','20x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'c03', name:'C-03', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','2x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','4x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'c04', name:'C-04', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','2x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','6x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'c05', name:'C-05', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','5x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','15x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'c06', name:'C-06', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','8x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'c07', name:'C-07', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','6x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','18x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'c08', name:'C-08', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','2x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','14x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'c09', name:'C-09', sqm:'14m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','4× LED arm light','1x) Display Shelving — 1452W×1700H×440D, Curved, Formica (WHT)','— YOUNGS —','Furniture'] },
  { key:'c10', name:'C-10', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','12x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','1x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','27x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'c11', name:'C-11', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'c12', name:'C-12', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','5x) 1700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','20x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'c13', name:'C-13', sqm:'26m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','4× LED arm light','— YOUNGS —','Furniture'] },
  { key:'c14', name:'C-14', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
];
const ZONE_D_TIER = [
  { key:'d01', name:'D-01', sqm:'14m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','4× LED arm light','2x) 900 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','3x) 1000 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','1x) 1950 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','14x) 10" Metal L-Bracket (WHT)','1x) Display Shelving — 1452W×1700H×440D, Curved, Formica (WHT)','— YOUNGS —','Furniture'] },
  { key:'d02', name:'D-02', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','1x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','1x) 900 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','1x) 1350 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','3x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','16x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'d03', name:'D-03', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','1x) 1350 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','3x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','12x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'d04', name:'D-04', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','3x) 1350 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','1x) 1800 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','13x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'d05', name:'D-05', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'d06', name:'D-06', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','1x) 1350 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','2x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','1x) 1800 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','13x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'d07', name:'D-07', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'d08', name:'D-08', sqm:'8m²', count:1, renders: [], req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'d09', name:'D-09', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','7x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','4x) 900 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','22x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'d10', name:'D-10', sqm:'10m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','2x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','2x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','2x) 1400 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','16x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
];
const ZONE_E_TIER = [
  { key:'e01', name:'E-01', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','1x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','1x) 900 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','1x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','7x) 10" Metal L-Bracket (WHT)','1× 4\'-6" Clothes Rack','1× 5\'-0" Clothes Rack','— YOUNGS —','Furniture'] },
  { key:'e02', name:'E-02', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'e03', name:'E-03', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','8x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','24x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'e04', name:'E-04', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','6x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','12x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture','4× Wire Grid 550×1100×50 (Youngs)'] },
  { key:'e05', name:'E-05', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','2× 5\'-0" Clothes Rack','4× 12" Rod for Clothes, Wall Mount','— YOUNGS —','Furniture','1× Wire Grid 550×1100×50 (Youngs)'] },
  { key:'e06', name:'E-06', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','1x) Display Case — 1902W×2092H×150D, Formica (WHT)','— YOUNGS —','Furniture'] },
  { key:'e07', name:'E-07', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','2x) 900 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','3x) 1000 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','10x) 10" Metal L-Bracket (WHT)','11× Hat/Coat Hook','— YOUNGS —','Furniture'] },
  { key:'e08', name:'E-08', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','8x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','6x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','28x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
];
const ZONE_F_TIER = [
  { key:'sm', name:'Booth', sqm:'6m²', count:11, req: ['43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Pop Up','Displays and shelvings'] },
  { key:'md', name:'Booth', sqm:'8m²', count:8, req: ['43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Pop Up','Displays and shelvings'] },
  { key:'lg', name:'Booth', sqm:'14m²', count:2, req: ['43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','4× LED arm light','— YOUNGS —','Pop Up','Displays and shelvings'] },
];
const ZONE_G_TIER = [
  { key:'sm', name:'Booth', sqm:'8m²', count:9, req: ['43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Pop Up','Displays and shelvings'] },
  { key:'lg', name:'Booth', sqm:'14m²', count:2, req: ['43" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','4× LED arm light','— YOUNGS —','Pop Up','Displays and shelvings'] },
];
const ZONE_CQ_TIER = [
  { key:'cq1', name:'CQ-1', sqm:'9m²', count:1, renders: ['chongqing-0825-5'], req: ['1× Std No Skin Panel — 3000W×2413H×500D','1× Std Counter — 990W×1000H×495D, Formica Black','1× 43" TV wall mount + Media Player','2× LED arm light','1× Fabric Graphic — 2966×2409mm, RX-101 Channel 9ft','Black+Orange Carpet'] },
  { key:'cq2', name:'CQ-2', sqm:'9m²', count:1, renders: ['chongqing-0825-6'], req: ['1× Std No Skin Panel — 3000W×2413H×500D','1× Std Counter — 990W×1000H×495D, Formica Black','1× 43" TV wall mount + Media Player','2× LED arm light','1× Fabric Graphic — 2966×2409mm, RX-101 Channel 9ft','Black+Orange Carpet'] },
  { key:'cq3', name:'CQ-3', sqm:'9m²', count:1, renders: ['chongqing-0825-7'], req: ['1× Std No Skin Panel — 3000W×2413H×500D','1× Std Counter — 990W×1000H×495D, Formica Black','1× 43" TV wall mount + Media Player','2× LED arm light','1× Fabric Graphic — 2966×2409mm, RX-101 Channel 9ft','Black+Orange Carpet'] },
];
...
const BOOTH_LABELS = {
  ...
  gb: ['GB-01 (6m²)','GB-02 (4m²)','GB-03 (4m²)','GB-04 (4m²)','GB-05 (4m²)','GB-06 (6m²)','GB-07 (4m²)','GB-08 (4m²)','GB-09 (4m²)','GB-10 (4m²)','GB-11 (4m²)','GB-12 (4m²)','GB-13 (4m²)','GB-14 (4m²)','GB-15 (4m²)','GB-16 (4m²)','GB-17 (4m²)','GB-18 (4m²)','GB-19 (4m²)','GB-20 (4m²)','GB-21 (4m²)','GB-22 (4m²)','GB-23 (4m²)','GB-24 (4m²)','GB-25 (4m²)','GB-26 (4m²)','GB-27 (4m²)','GB-28 (4m²)','GB-29 (4m²)','GB-30 (4m²)','GB-31 (4m²)','GB-32 (4m²)','GB-33 (4m²)','GB-34 (4m²)','GB-35 (4m²)','GB-36 (4m²)','GB-37 (4m²)','GB-38 (4m²)','GB-39 (4m²)','GB-40 (4m²)','GB-41 (4m²)','GB-42 (4m²)','GB-43 (4m²)','GB-44 (4m²)'],
};
...
ZONES: [
  ...
  { name: 'Buyer Story', owner: 'Chris', status: 'Approved', img: 'buyer-story-v2-2', renders: ['buyer-story-0825-2', 'buyer-story-0825-3', 'buyer-story-0825-4', 'buyer-story-0825-5', 'buyer-story-0825-6'], scope: 'Youngs provide structure. AMG build + 1× 43" TV (portrait) + stand + Media Player.', flag: '⚠ Youngs structure · AMG build + TV',
    req: ['Structure (by Youngs)', 'AMG build', '1× 43" TV (portrait) + stand + Media Player'] },
  { name: 'Unboxing Live', owner: 'Charles', status: 'Approved', img: 'unboxing-live-render-1', renders: ['unboxing-live-0825-2'], scope: 'R4 — Display block ×3, Double-sided Pop-up, 55" TV, Furniture by Youngs, Carpet 5584×5584mm', flag: '⚠ R4 — Pop-up + Display blocks + TV', req: ['1× Custom Display Box #03 — 300W×600H×300D, White Formica', '1× Custom Display Box #04 — 300W×650H×300D, White Formica', '1× Custom Display Box #05 — 300W×450H×300D, White Formica', 'Double-sided Pop-up', '1× 55" TV w/ stand', 'Furniture by Youngs', '1× Carpet — 5584 (W)×5584 (L), Finish (Pendent), 343 sqft'] },
  { name: 'Supplier A200 — Block A', owner: 'Jin', status: 'Approved', img: 'zone-a-map-0825b', renders: ['zone-a-map-0825b'], drawings: [], scope: 'A-01 ~ A-09. 9× 8sqm. Wooden backdrop (4×2.5mH) + 43" TV + stand + Media Player + Std Counter + Grey carpet + AMG provide shelf & L-bracket.', flag: '9× 8sqm · 8 std counters · AMG shelf',
    req: ['8× Wooden backdrop (4×2.5mH)', '8× 43" TV + stand + Media Player', '8× Std Counter — 990W×1000H×495D, Formica White', '9× Grey carpet (≈792 sqft)', '16× LED arm light', '3× Metal Panel Footing', '— AMG Shelf —', '27× 700mm shelf, Formica (WHT) (23× @300D + 4× @400D A-08)', '4× 900mm shelf, Formica (WHT) (4× @400D A-02)', '3× 1500mm shelf, Formica (WHT)', '73× 450mm shelf, Formica (WHT)', '213× 10" Metal L-Bracket (WHT)', '— YOUNGS —', '8× Furniture', '2× Wire Grid 550×1100×50 (A-04 only)'], tiers: ZONE_A_TIER, units: makeTieredUnits('zone-a', ZONE_A_TIER, i => BOOTH_LABELS.a[i-1], n => [`zone-a-render-${n*2}`, `zone-a-render-${n*2-1}`]) },
  { name: 'Supplier A200 — Block B', owner: 'Jin', status: 'Approved', img: 'zone-b-map-0825', renders: ['zone-b-map-0825'], drawings: [], scope: 'B-01 ~ B-07. 5×8m² + 1×12m² + 1×16m². Wooden backdrop (4×2.5mH) + 43" TV + stand + Media Player + Std Counter + Grey carpet. A200 standard build.', flag: '7 booths · 7 std counters · 5×8 + 12 + 16m²',
    req: ['7× Wooden backdrop (4×2.5mH)', '7× 43" TV + stand + Media Player', '7× Std Counter — 990W×1000H×495D, Formica White', '7× Grey carpet (≈748 sqft)', '14× LED arm light', '4× Metal Panel Footing', '— YOUNGS —', '7× Furniture'], tiers: ZONE_B_TIER, units: makeTieredUnits('zone-b', ZONE_B_TIER, i => BOOTH_LABELS.b[i-1], n => [`zone-b-render-${n*2}`, `zone-b-render-${n*2-1}`]) },
  { name: 'Supplier A200 — Block C', owner: 'Chris', status: 'Approved', img: 'zone-c-map-0825', renders: ['zone-c-map-0825'], drawings: [], scope: 'C-01 ~ C-14. 12×8m² + 1×14m² + 1×26m². Wooden backdrop (4×2.5mH) + 43" TV + stand + Media Player + Std Counter + Grey carpet + AMG provide shelf & L-bracket.', flag: '14 booths · 14 std counters · AMG shelf',
    req: ['14× Wooden backdrop (4×2.5mH)', '14× 43" TV + stand + Media Player', '14× Std Counter — 990W×1000H×495D, Formica White', '14× Grey carpet (≈1496 sqft)', '32× LED arm light', '6× Metal Panel Footing', '— AMG Shelf —', '20× 700mm shelf, Formica (WHT)', '12× 450mm shelf, Formica (WHT)', '16× 1500mm shelf, Formica (WHT)', '5× 1700mm shelf, Formica (WHT)', '1× Display Shelving — 1452×1700×440, Curved, Formica (WHT) (C-09)', '132× 10" Metal L-Bracket (WHT)', '— YOUNGS —', '14× Furniture'], tiers: ZONE_C_TIER, units: makeTieredUnits('zone-c', ZONE_C_TIER, i => BOOTH_LABELS.c[i-1], n => [`zone-c-render-${n*2}`, `zone-c-render-${n*2-1}`]) },
  { name: 'Supplier A200 — Block D', owner: 'Chris', status: 'Approved', img: 'zone-d-map-0825', renders: ['zone-d-map-0825'], drawings: [], scope: 'D-01 ~ D-10. 1×14m² + 8×8m² + 1×10m² = 88m². Wooden backdrop + TV + Std Counter + Grey carpet + AMG shelf & L-bracket.', flag: '10 booths · 10 std counters · AMG shelf',
    req: ['10× Wooden backdrop (4×2.5mH)', '10× 43" TV + stand + Media Player', '10× Std Counter — 990W×1000H×495D, Formica White', '10× Grey carpet (≈968 sqft)', '22× LED arm light', '3× Metal Panel Footing', '— AMG Shelf —', '3× 450mm shelf, Formica (WHT)', '9× 700mm shelf, Formica (WHT)', '7× 900mm shelf, Formica (WHT)', '3× 1000mm shelf, Formica (WHT)', '6× 1350mm shelf, Formica (WHT)', '8× 1500mm shelf, Formica (WHT)', '2× 1800mm shelf, Formica (WHT)', '2× 1400mm shelf, Formica (WHT)', '1× 1950mm shelf, Formica (WHT)', '1× Display Shelving — 1452×1700×440, Curved, Formica (WHT) (D-01)', '106× 10" Metal L-Bracket (WHT)', '— YOUNGS —', '10× Furniture'], tiers: ZONE_D_TIER, units: makeTieredUnits('zone-d', ZONE_D_TIER, i => BOOTH_LABELS.d[i-1], n => [`zone-d-render-${n*2}`, `zone-d-render-${n*2-1}`]) },
  { name: 'Supplier A200 — Block E', owner: 'Chris', status: 'Approved', img: 'zone-e-map-0825', renders: ['zone-e-map-0825'], drawings: [], scope: 'E-01 ~ E-08. 8× 8m². Wooden backdrop (4×2.5mH) + 43" TV + stand + Media Player + Std Counter + Grey carpet + AMG provide shelf & L-bracket.', flag: '8× 8m² · 8 std counters · AMG shelf',
    req: ['8× Wooden backdrop (4×2.5mH)', '8× 43" TV + stand + Media Player', '8× Std Counter — 990W×1000H×495D, Formica White', '8× Grey carpet (≈704 sqft)', '16× LED arm light', '4× Metal Panel Footing', '— AMG Shelf —', '17× 450mm shelf, Formica (WHT)', '16× 700mm shelf, Formica (WHT)', '3× 900mm shelf, Formica (WHT)', '3× 1000mm shelf, Formica (WHT)', '1× 1500mm shelf, Formica (WHT)', '1× Display Case — 1902×2092×150, Formica (WHT) (E-06)', '81× 10" Metal L-Bracket (WHT)', '4× Clothes Rack (1×4\'6" + 3×5\'0")', '4× 12" Rod for Clothes', '11× Hat/Coat Hook', '— YOUNGS —', '8× Furniture', '5× Wire Grid 550×1100×50'], tiers: ZONE_E_TIER, units: makeTieredUnits('zone-e', ZONE_E_TIER, i => BOOTH_LABELS.e[i-1], n => [`zone-e-render-${n*2}`, `zone-e-render-${n*2-1}`]) },
  { name: 'Supplier Non-A200 — Block F', owner: 'Iris', status: 'Approved', img: 'zone-f-map-0825', renders: ['zone-f-map-0825'], drawings: [], scope: 'F-01 ~ F-21. 11×6m² + 8×8m² + 2×14m² = 158m². YOUNGS Pop Up. AMG provide counter + TV + lighting + bracket.', flag: '21 booths · 21 std counters · 11/8/2',
    req: ['21× Std Counter — 990W×1000H×495D, Formica White, Lockable Door+Shelf', '21× 43" TV + Media Player + HDMI Cable + Floor Stand', '21× Grey carpet (≈1738 sqft)', '46× LED Arm Light', '26× Popup Bracket for PVC Graphic', '— YOUNGS —', 'Pop Up', 'Displays and shelvings'], tiers: ZONE_F_TIER, units: makeTieredUnits('zone-f', ZONE_F_TIER, i => BOOTH_LABELS.f[i-1], n => [`zone-f-render-${n*2}`, `zone-f-render-${n*2-1}`]) },
  { name: 'Supplier Non-A200 — Block G', owner: 'Iris', status: 'TBD', img: 'zone-g-map-0825', renders: ['zone-g-map-0825'], drawings: [], scope: 'G-01 ~ G-11. 9×8m² + 2×14m². YOUNGS Pop Up. AMG provide counter + TV + lighting + bracket.', flag: '11 booths · 11 std counters · 9/2',
    req: ['11× Std Counter — 990W×1000H×495D, Formica White, Lockable Door+Shelf', '11× 43" TV + Media Player + HDMI Cable + Floor Stand', '11× Grey carpet (≈1100 sqft)', '26× LED Arm Light', '22× Popup Bracket for PVC Graphic', '— YOUNGS —', 'Pop Up', 'Displays and shelvings'], tiers: ZONE_G_TIER, units: makeTieredUnits('zone-g', ZONE_G_TIER, i => BOOTH_LABELS.g[i-1], n => [`zone-g-render-${n*2}`, `zone-g-render-${n*2-1}`]) },
  { name: 'Chongqing Pavilion', owner: 'Chris', status: 'Approved', img: 'chongqing-map', renders: ['chongqing-0825-2', 'chongqing-0825-3', 'chongqing-0825-4'], drawings: ['chongqing-dwg-3'], scope: 'AMG shop drawings A.2–A.4 (JP, RENT). 27m² (3× 9sqm). Central: LED Lighting Structure 1200mm dia×3450mm H + 27× LED strips + 3× Display Stands (BLK Formica). Perimeter: 3× Std No Skin Panels 990×2413 + 43" TV + stand + Media Player wall mount + Counter. Floor Trim 260ft.', flag: '3× 9sqm booths',
    req: ['3× Std No Skin Panel — 3000W×2413H×500D', '3× Std Counter — 990W×1000H×495D, Formica Black', '3× 43" TV wall mount + Media Player', '3× Fabric Graphic — 2966×2409mm, RX-101 Channel 27ft', '6× LED arm light', '3× 9sqm Booths, Black+Orange Carpet'], tiers: ZONE_CQ_TIER, units: makeTieredUnits('cq', ZONE_CQ_TIER, i => BOOTH_LABELS.cq[i-1]) },
  { name: 'Sponsor Booths 16+1', owner: 'Jin', status: 'Approved', img: 'sponsor-booths-map-0825', renders: ['sponsor-booths-map-0825'], drawings: [], scope: 'AMG shop drawings A.2–A.5 (JP, RENT). 17 booths (P-01 ~ P-17): 8×8ft ×10, 10×10ft ×3, 10×15ft ×2, 10×20ft ×1 (P-14 空地, AMG 不提供).', flag: '16+1 booths · 1× 空地',
    req: ['15× Std Counter — 990W×1000H×495D, Formica White', '1× Custom Counter — 1800W×500H×1000D, wooden joinery (Premier)', '5× 43" TV + stand + Media Player', '1× 43" TV wall mount + Media Player (Premier)', '16× Grey carpet (≈1440 sqft)', '1× L-shaped wall structure (Premier)', '2× Full-height wall graphic, front only (Premier)', '51× LED arm light', '— YOUNGS —', 'Pop-up display', 'Furniture + fabric display'],
    tiers: SPONSOR_TIERS,
...
GRAPHICS: [
  ...
  { zone: 'Supplier Block D', items: [
    ...
    { item: 'D-03-HEADER', size: '1600×250mm', material: 'PVC', qty: 1, status: 'approved', thumb: '' },
    ...
    { item: 'D-08-HEADER', size: '1600×250mm', material: 'PVC', qty: 1, status: 'pending', thumb: '' },
    { item: 'D-08-BK-WALL', size: '3942×2409mm', material: 'BO Fabric', qty: 1, status: 'pending', thumb: '' },
    { item: 'D-08-SIDE-WALL-IN', size: '1962×2409mm', material: 'BO Fabric', qty: 1, status: 'pending', thumb: '' },
  ...
  { zone: 'Supplier Non-A200 — Block F', items: [
    { item: 'F-01-HEADER', size: '1600×250mm', material: 'PVC', qty: 1, status: 'pending', thumb: 'assets/graphics/f-01-header.jpg' },
    { item: 'F-02-HEADER', size: '1600×250mm', material: 'PVC', qty: 1, status: 'pending', thumb: 'assets/graphics/f-02-header.jpg' },
    { item: 'F-03-HEADER', size: '1600×250mm', material: 'PVC', qty: 1, status: 'pending', thumb: 'assets/graphics/f-03-header.jpg' },
    { item: 'F-04-HEADER', size: '1600×250mm', material: 'PVC', qty: 1, status: 'pending', thumb: 'assets/graphics/f-04-header.jpg' },
    { item: 'F-05-HEADER', size: '1600×250mm', material: 'PVC', qty: 1, status: 'pending', thumb: 'assets/graphics/f-05-header.jpg' },
    { item: 'F-06-HEADER', size: '1600×250mm', material: 'PVC', qty: 1, status: 'pending', thumb: 'assets/graphics/f-06-header.jpg' },
    { item: 'F-07-HEADER', size: '1600×250mm', material: 'PVC', qty: 1, status: 'pending', thumb: 'assets/graphics/f-07-header.jpg' },
    { item: 'F-08-HEADER', size: '1600×250mm', material: 'PVC', qty: 1, status: 'pending', thumb: 'assets/graphics/f-08-header.jpg' },
    { item: 'F-09-HEADER', size: '1600×250mm', material: 'PVC', qty: 1, status: 'pending', thumb: 'assets/graphics/f-09-header.jpg' },
    { item: 'F-10-HEADER', size: '1600×250mm', material: 'PVC', qty: 1, status: 'pending', thumb: 'assets/graphics/f-10-header.jpg' },
    { item: 'F-11-HEADER', size: '1600×250mm', material: 'PVC', qty: 1, status: 'pending', thumb: 'assets/graphics/f-11-header.jpg' },
    { item: 'F-12-HEADER', size: '1600×250mm', material: 'PVC', qty: 1, status: 'pending', thumb: 'assets/graphics/f-12-header.jpg' },
    { item: 'F-13-HEADER', size: '1600×250mm', material: 'PVC', qty: 1, status: 'pending', thumb: 'assets/graphics/f-13-header.jpg' },
    { item: 'F-14-HEADER', size: '1600×250mm', material: 'PVC', qty: 1, status: 'pending', thumb: 'assets/graphics/f-14-header.jpg' },
    { item: 'F-15-HEADER', size: '1600×250mm', material: 'PVC', qty: 1, status: 'pending', thumb: 'assets/graphics/f-15-header.jpg' },
    { item: 'F-16-HEADER', size: '1600×250mm', material: 'PVC', qty: 1, status: 'pending', thumb: 'assets/graphics/f-16-header.jpg' },
    { item: 'F-17-HEADER', size: '1600×250mm', material: 'PVC', qty: 1, status: 'pending', thumb: 'assets/graphics/f-17-header.jpg' },
    { item: 'F-18-HEADER', size: '1600×250mm', material: 'PVC', qty: 1, status: 'pending', thumb: 'assets/graphics/f-18-header.jpg' },
    { item: 'F-19-HEADER', size: '1600×250mm', material: 'PVC', qty: 1, status: 'pending', thumb: 'assets/graphics/f-19-header.jpg' },
    { item: 'F-20-HEADER', size: '1600×250mm', material: 'PVC', qty: 1, status: 'pending', thumb: 'assets/graphics/f-20-header.jpg' },
    { item: 'F-21-HEADER', size: '1600×250mm', material: 'PVC', qty: 1, status: 'pending', thumb: 'assets/graphics/f-21-header.jpg' },
  ...
  { zone: 'Supplier Non-A200 — Block G', items: [
    { item: 'G-01-HEADER', size: '1600×250mm', material: 'PVC', qty: 1, status: 'pending', thumb: 'assets/graphics/g-01-header.jpg' },
    { item: 'G-02-HEADER', size: '1600×250mm', material: 'PVC', qty: 1, status: 'pending', thumb: 'assets/graphics/g-02-header.jpg' },
    { item: 'G-03-HEADER', size: '1600×250mm', material: 'PVC', qty: 1, status: 'pending', thumb: 'assets/graphics/g-03-header.jpg' },
    { item: 'G-04-HEADER', size: '1600×250mm', material: 'PVC', qty: 1, status: 'pending', thumb: 'assets/graphics/g-04-header.jpg' },
    { item: 'G-05-HEADER', size: '1600×250mm', material: 'PVC', qty: 1, status: 'pending', thumb: 'assets/graphics/g-05-header.jpg' },
    { item: 'G-06-HEADER', size: '1600×250mm', material: 'PVC', qty: 1, status: 'pending', thumb: 'assets/graphics/g-06-header.jpg' },
    { item: 'G-07-HEADER', size: '1600×250mm', material: 'PVC', qty: 1, status: 'pending', thumb: 'assets/graphics/g-07-header.jpg' },
  ...
  { zone: 'Sponsor Booths', items: [
    ...
    { item: 'COMM-P-10-LOGO', size: '800×150mm', material: 'Vinyl', qty: 1, status: 'pending', thumb: '' },
