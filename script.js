...
ZONES: [
  ...
  { name: 'Chongqing Pavilion', owner: 'Iris', status: 'Approved', img: 'chongqing-v2-2', renders: ['chongqing-v2-2', 'chongqing-map'], drawings: ['chongqing-dwg-3'], scope: 'AMG shop drawings A.2–A.4 (JP, RENT). 36m² (4× 9sqm). Central: LED Lighting Structure 1200mm dia×3450mm H + 36× LED strips + 4× Display Stands (BLK Formica). Perimeter: 3× Std No Skin Panels 990×2413 + 42" TV + stand + Media Player wall mount + Counter. Floor Trim 260ft.', flag: '4× 9sqm booths',
