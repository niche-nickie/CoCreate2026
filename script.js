...
ZONES: [
  ...
  { name: 'Keynote Hall', owner: 'Ari', status: 'TBD', img: 'keynote-dark', renders: ['keynote-light'], scope: 'Dark + Light visual versions. 3,840m² / 1,200pax. Largest space.', flag: '3,840m² / 1,200pax. Largest space.', blocking: true, req: [] },
