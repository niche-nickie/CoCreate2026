...
ZONES: [
  ...
  { name: 'Keynote Hall', owner: 'Ari', status: 'TBD', img: 'keynote-render', renders: ['keynote-dark', 'keynote-plan'], scope: 'AMG only provide stage carpet (6.1m × 21m ≈ 1,379 sq ft).', flag: '⚠ AMG scope: stage carpet only · 6.1m × 21m', blocking: true, req: ['Stage carpet (AMG scope)', 'All other items — by Youngs / Client'] },
