...
const IMG_CACHE_BUST = '?v=20260826h';  // bump to bust image CDN cache
...
ZONES: [
  ...
  { name: 'Supplier A200 — Block C', owner: 'Chris', status: 'Approved', img: 'zone-c-map-0825', renders: ['zone-c-map-0825'], drawings: [], scope: 'C-01 ~ C-14. 12×8m² + 1×14m² + 1×26m². Wooden backdrop (4×2.5mH) + 42" TV + stand + Media Player + Std Counter + Grey carpet + AMG provide shelf & L-bracket.', flag: '14 booths · 14 std counters · AMG shelf',
  ...
  { name: 'Supplier A200 — Block E', owner: 'Chris', status: 'Approved', img: 'zone-e-map-0825', renders: ['zone-e-map-0825'], drawings: [], scope: 'E-01 ~ E-08. 8× 8m². Wooden backdrop (4×2.5mH) + 42" TV + stand + Media Player + Std Counter + Grey carpet + AMG provide shelf & L-bracket.', flag: '8× 8m² · 8 std counters · AMG shelf',
