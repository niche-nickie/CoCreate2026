...
function makeTieredUnits(prefix, tiers, labelFn){
  const units = [];
  tiers.forEach(tier => {
...
ZONES: [
  ...
  { name: 'Supplier A200 — Zone A', owner: 'Jin & Chris', status: 'In Review', img: 'zone-a-render-1', renders: [...gallery('zone-a-render', 9)], drawings: [...gallery('zone-a-plan', 9)], scope: 'A-01 ~ A-09. 9× 8sqm. Wooden backdrop (4×2.5mH) + 42" TV + Std Counter + Grey carpet. A200 standard build.', flag: '9× 8sqm · 9 std counters',
    req: ['Wooden backdrop (4×2.5mH)', '42" TV', 'Std Counter', 'Grey carpet', 'Furniture (by Youngs)'], tiers: ZONE_A_TIER, units: makeTieredUnits('zone-a', ZONE_A_TIER, BOOTH_LABELS.a) },
  { name: 'Supplier A200 — Zone B', owner: 'Jin & Chris', status: 'In Review', img: 'zone-b-render-1', renders: [...gallery('zone-b-render', 7)], drawings: [...gallery('zone-b-plan', 7)], scope: 'B-01 ~ B-08. 7× 8sqm. Wooden backdrop (4×2.5mH) + 42" TV + Std Counter + Grey carpet. A200 standard build.', flag: '7× 8sqm · 7 std counters',
    req: ['Wooden backdrop (4×2.5mH)', '42" TV', 'Std Counter', 'Grey carpet', 'Furniture (by Youngs)'], tiers: ZONE_B_TIER, units: makeTieredUnits('zone-b', ZONE_B_TIER, BOOTH_LABELS.b) },
  { name: 'Supplier A200 — Zone C', owner: 'Jin & Chris', status: 'In Review', img: 'zone-c-render-1', renders: [...gallery('zone-c-render', 10)], drawings: [...gallery('zone-c-plan', 10)], scope: 'C-01 ~ C-11. 10× 8sqm + 1× 18sqm. Wooden backdrop (4×2.5mH) + 42" TV + Std Counter + Grey carpet. A200 standard build.', flag: '11 booths · 11 std counters',
    req: ['Wooden backdrop (4×2.5mH)', '42" TV', 'Std Counter', 'Grey carpet', 'Furniture (by Youngs)'], tiers: ZONE_C_TIER, units: makeTieredUnits('zone-c', ZONE_C_TIER, BOOTH_LABELS.c) },
  { name: 'Supplier A200 — Zone D', owner: 'Jin & Chris', status: 'In Review', img: 'zone-d-render-1', renders: [...gallery('zone-d-render', 10)], drawings: [...gallery('zone-d-plan', 10)], scope: 'D-01 ~ D-10. 8/14/8+2sqm mixed. Wooden backdrop (4×2.5mH) + 42" TV + Std Counter + Grey carpet. A200 standard build.', flag: '10 booths · 10 std counters',
    req: ['Wooden backdrop (4×2.5mH)', '42" TV', 'Std Counter', 'Grey carpet', 'Furniture (by Youngs)'], tiers: ZONE_D_TIER, units: makeTieredUnits('zone-d', ZONE_D_TIER, BOOTH_LABELS.d) },
  { name: 'Supplier A200 — Zone E', owner: 'Jin & Chris', status: 'In Review', img: 'zone-e-render-1', renders: [...gallery('zone-e-render', 8)], drawings: [...gallery('zone-e-plan', 8)], scope: 'E-01 ~ E-08. 8× 8sqm. Wooden backdrop (4×2.5mH) + 42" TV + Std Counter + Grey carpet. A200 standard build.', flag: '8× 8sqm · 8 std counters',
    req: ['Wooden backdrop (4×2.5mH)', '42" TV', 'Std Counter', 'Grey carpet', 'Furniture (by Youngs)'], tiers: ZONE_E_TIER, units: makeTieredUnits('zone-e', ZONE_E_TIER, BOOTH_LABELS.e) },
  { name: 'Supplier Non-A200 — Zone F', owner: 'Jin & Chris', status: 'In Review', img: 'zone-f-render-1', renders: [...gallery('zone-f-render', 20)], drawings: [...gallery('zone-f-plan', 19)], scope: 'F-01 ~ F-21. 4/6/8/14sqm mixed. 快幕秀 quick-pop backdrop + 42" TV + Fabric display + shelving (Youngs).', flag: '21 booths · 21 std counters',
    req: ['快幕秀 quick-pop backdrop', '42" TV', 'Fabric display + shelving (by Youngs)'], tiers: ZONE_F_TIER, units: makeTieredUnits('zone-f', ZONE_F_TIER, BOOTH_LABELS.f) },
