...
const IMG_CACHE_BUST = '?v=20260812v';  // bump to bust image CDN cache
...
ZONES: [
  ...
  { name: 'Supplier A200 — Block C', owner: 'Jin & Chris', status: 'In Review', img: 'zone-c-map', renders: ['zone-c-map'], drawings: [], scope: 'C-01 ~ C-13. 11×8m² + 1×14m² + 1×26m². Wooden backdrop (4×2.5mH) + 42" TV + stand + Media Player + Std Counter + Grey carpet + AMG provide shelf & L-bracket.', flag: '13 booths · 13 std counters · AMG shelf',
    req: ['13× Wooden backdrop (4×2.5mH)', '13× 42" TV + stand + Media Player', '13× Std Counter', '13× Grey carpet (≈1408 sqft)', '30× LED arm light', '6× Metal Panel Footing', '— AMG Shelf —', '16× 700mm shelf, Formica (WHT)', '12× 450mm shelf, Formica (WHT)', '19× 1500mm shelf, Formica (WHT)', '5× 1700mm shelf, Formica (WHT)', '1× Display Shelving — 1452×1700×440, Curved, Formica (WHT) (C-09)', '133× 10" Metal L-Bracket (WHT)', '— YOUNGS —', '13× Furniture'], tiers: ZONE_C_TIER, units: makeTieredUnits('zone-c', ZONE_C_TIER, i => BOOTH_LABELS.c[i-1], n => [`zone-c-render-${n*2}`, `zone-c-render-${n*2-1}`]) },
  { name: 'Supplier A200 — Block D', owner: 'Jin & Chris', status: 'In Review', img: 'zone-d-map', renders: ['zone-d-map'], drawings: [], scope: 'D-01 ~ D-07, D-09 ~ D-10. 1×14m² + 7×8m² + 1×10m² = 80m². Wooden backdrop + TV + Std Counter + Grey carpet + AMG shelf & L-bracket.', flag: '9 booths · 9 std counters · AMG shelf (D-08 removed)',
    req: ['9× Wooden backdrop (4×2.5mH)', '9× 42" TV + stand + Media Player', '9× Std Counter', '9× Grey carpet (≈880 sqft)', '20× LED arm light', '3× Metal Panel Footing', '— AMG Shelf —', '9× 450mm shelf, Formica (WHT)', '9× 700mm shelf, Formica (WHT)', '7× 900mm shelf, Formica (WHT)', '3× 1000mm shelf, Formica (WHT)', '5× 1350mm shelf, Formica (WHT)', '7× 1500mm shelf, Formica (WHT)', '3× 1800mm shelf, Formica (WHT)', '1× 1950mm shelf, Formica (WHT)', '1× Display Shelving — 1452×1700×440, Curved, Formica (WHT) (D-01)', '108× 10" Metal L-Bracket (WHT)', '— YOUNGS —', '9× Furniture'], tiers: ZONE_D_TIER, units: makeTieredUnits('zone-d', ZONE_D_TIER, i => BOOTH_LABELS.d[i-1], n => [`zone-d-render-${n*2}`, `zone-d-render-${n*2-1}`]) },
