...
ZONES: [
  ...
  { name: 'Keynote Hall', owner: 'Ari', status: 'TBD', img: 'keynote-render', renders: ['keynote-plan'], scope: 'AMG only provide stage carpet. 3,840m² / 1,200pax. Largest space.', flag: '⚠ AMG scope: stage carpet only · 3,840m² · 1,200pax', blocking: true, req: ['Stage carpet (AMG scope)', 'All other items — by Youngs / Client'] },
