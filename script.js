...
ZONES: [
  ...
  { name: 'AMA / Influencer Hub', owner: 'Ari', status: 'Quoted', img: 'ama-hub-v2-2', renders: ['ama-hub-v2-2'], drawings: ['ama-hub-dwg-1'], scope: 'YOUNGS X JOHNATHAN — Banner ×6, Stage, Furniture by Youngs', flag: 'YOUNGS X JOHNATHAN', req: ['6× Banner', 'Stage', 'Furniture by Youngs', 'JT (Johnathan) AVL'] },

  { name: 'Match Meeting', owner: 'Ari', status: 'TBD', scope: 'AVL: Johnathan.', flag: 'Johnathan', req: [] },
