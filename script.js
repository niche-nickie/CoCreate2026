...
ZONES: [
  ...
  { name: 'UED Booth', owner: 'Jin & Chris', status: 'In Review', img: 'ued-booth', renders: ['ued-booth-2', 'ued-booth-3'], drawings: ['ued-booth-dwg-1', 'ued-booth-dwg-2'], scope: 'AMG shop drawings A.1–A.2 (JP, RENT). 5× Std Panel 990×2413 + 2× Graphic Bracket + Cover PVC. 4× Std Counter 990×1000 + 3× 495×1000 (WHT Formica 949-58). 2× Display Stand 730×1420 (WHT/BLK). 55" TV + 12× Stanchion + 4× LED Arm Light. 82ft RX-101. 2× Fabric Graphics. Machines/laptops by Youngs.', flag: '55" TV + 12 stanchions · Machines/laptops by Youngs',
