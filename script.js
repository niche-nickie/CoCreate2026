...
const ZONE_C_TIER = [
  ...
  { key:'c14', name:'C-14', sqm:'8m²', count:1, renders: ['c14-render-1'], drawings: ['block-c-dwg-22'], req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
];
const ZONE_D_TIER = [
...
ZONES: [
  ...
  { name: 'Supplier Non-A200 — Block F', owner: 'Seyu', status: 'Approved', img: 'zone-f-map-0825', renders: ['zone-f-map-0825'], drawings: ['block-f-dwg-1', 'block-f-dwg-2', 'block-f-dwg-3'], scope: 'F-01 ~ F-21. 11×6m² + 8×8m² + 2×14m² = 158m². YOUNGS Pop Up. AMG provide counter + TV + lighting + bracket.', flag: '21 booths · 21 std counters · 11/8/2',
  ...
  { name: 'Supplier Non-A200 — Block G', owner: 'Seyu', status: 'TBD', img: 'zone-g-map-0825', renders: ['zone-g-map-0825'], drawings: ['block-g-dwg-1', 'block-g-dwg-2'], scope: 'G-01 ~ G-11. 9×8m² + 2×14m². YOUNGS Pop Up. AMG provide counter + TV + lighting + bracket.', flag: '11 booths · 11 std counters · 9/2',
  ...
  { name: 'National Pavilion', owner: 'Seyu', status: 'In Review', img: 'national-gb-map', renders: ['national-gb-map'], drawings: ['national-dwg-1', 'national-dwg-2'], scope: 'GB-01 ~ GB-44 (42 booths, GB-25 & GB-29 withdrew). AMG provide carpet + LED arm light only. 3 groups: GB-US×19, GB-Pakistan×9, GB-Others×14.', flag: '42 booths · carpet + lights only',
