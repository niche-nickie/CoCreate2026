...
const IMG_CACHE_BUST = '?v=20260822';  // bump to bust image CDN cache
...
ZONES: [
  ...
  { name: 'Creator Market (Muse)', owner: 'Iris', status: 'Approved', img: 'muse-scope-2', renders: [...gallery('muse-scope', 9)], drawings: [], scope: 'Muse client design (revised 8/14) · Island + Sponsor. 1× Circular flooring 320sqm. 3× 75" TV. 5× Std Counter — 990W×1000H×495D, Formica White. 4× Custom wood frame. 3× PVC graphic. 6× Custom column. 1× Vinyl sticker.', flag: 'Structure confirmed 8/17 · 22 booths (12× 8sqm + 6× 16sqm + 4× 32sqm)',
    req: ['1× Circular flooring — black/grey/white w/ text (320sqm)', '3× 75" TV w/ stand', '5× Std Counter — 990W×1000H×495D, Formica White', '4× Custom wood frame structure w/ base (open 5 sides, overhead crossbeam for fishing lines)', '3× PVC graphic on both sides', '6× Custom Column (Island)', '1× Vinyl sticker (Sponsor)'] },
