...
const ZONE_A_TIER = [
  ...
  { key:'a02', name:'A-02', sqm:'8m²', count:1, renders: ['zone-a-render-9', 'zone-a-render-10'], req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','4x) 900 (W)*18 (H)*400 (D), Shelf, Formica (WHT)','9x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','26x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  ...
  { key:'a05', name:'A-05', sqm:'8m²', count:1, renders: [], req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','9x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','26x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
