...
const ZONE_A_TIER = [
  { key:'a01', name:'A-01', sqm:'8m²', count:1, renders: ['a-01-0903'], drawings: ['block-a-dwg-8'], req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','9x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','26x) 10" Metal L-Bracket (WHT)'] },
  { key:'a02', name:'A-02', sqm:'8m²', count:1, drawings: ['block-a-dwg-9'], renders: ['a-02-0903', 'a-02-0903-2', 'a-02-layout'], req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','9x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','26x) 10" Metal L-Bracket (WHT)'] },
  { key:'a03', name:'A-03', sqm:'8m²', count:1, renders: ['a-03-0903'], drawings: ['block-a-dwg-10'], req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','7x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','26x) 10" Metal L-Bracket (WHT)'] },
  { key:'a04', name:'A-04', sqm:'8m²', count:1, renders: ['a-04-0903'], drawings: ['block-a-dwg-11'], req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','3x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','9x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','24x) 10" Metal L-Bracket (WHT)'] },
  { key:'a05', name:'A-05', sqm:'8m²', count:1, drawings: ['block-a-dwg-12'], renders: ['a-05-0903', 'a-05-0903-2', 'a-05-layout'], req: ['Grey carpet'] },
  { key:'a06', name:'A-06', sqm:'8m²', count:1, renders: ['a-06-0903'], drawings: ['block-a-dwg-13'], req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','10x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','28x) 10" Metal L-Bracket (WHT)'] },
  { key:'a07', name:'A-07', sqm:'8m²', count:1, renders: ['a-07-0903'], drawings: ['block-a-dwg-14'], req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','9x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','26x) 10" Metal L-Bracket (WHT)'] },
  { key:'a08', name:'A-08', sqm:'8m²', count:1, renders: ['a-08-0903'], drawings: ['block-a-dwg-15'], req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*400 (D), Shelf, Formica (WHT)','11x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','30x) 10" Metal L-Bracket (WHT)'] },
...
const ZONE_C_TIER = [
  { key:'c01', name:'C-01', sqm:'8m²', count:1, renders: ['c01-0903'], drawings: ['block-c-dwg-9'],  req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light'] },
  { key:'c02', name:'C-02', sqm:'8m²', count:1, renders: ['c02-0903'], drawings: ['block-c-dwg-10'],  req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','10x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','20x) 10" Metal L-Bracket (WHT)'] },
  { key:'c03', name:'C-03', sqm:'8m²', count:1, renders: ['c03-0903'], drawings: ['block-c-dwg-11'],  req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','2x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','4x) 10" Metal L-Bracket (WHT)'] },
  { key:'c04', name:'C-04', sqm:'8m²', count:1, renders: ['c04-0903'], drawings: ['block-c-dwg-12'],  req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','2x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','6x) 10" Metal L-Bracket (WHT)'] },
  { key:'c05', name:'C-05', sqm:'8m²', count:1, renders: ['c05-0903'], drawings: ['block-c-dwg-13'],  req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','5x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','15x) 10" Metal L-Bracket (WHT)'] },
  { key:'c06', name:'C-06', sqm:'8m²', count:1, renders: ['c06-0903'], drawings: ['block-c-dwg-14'],  req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','8x) 10" Metal L-Bracket (WHT)'] },
  { key:'c07', name:'C-07', sqm:'8m²', count:1, renders: ['c07-0903'], drawings: ['block-c-dwg-15'],  req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','6x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','18x) 10" Metal L-Bracket (WHT)'] },
  { key:'c08', name:'C-08', sqm:'8m²', count:1, renders: ['c08-0903'], drawings: ['block-c-dwg-16'],  req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','2x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','14x) 10" Metal L-Bracket (WHT)'] },
  { key:'c09', name:'C-09', sqm:'14m²', count:1, renders: ['c09-0903'], drawings: ['supplier-display-dwg-1', 'block-c-dwg-17'], req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','4× LED arm light','1x) Display Shelving — 1452W×1700H×440D, Curved, Formica (WHT)'] },
  { key:'c10', name:'C-10', sqm:'8m²', count:1, renders: ['c10-0903'], drawings: ['block-c-dwg-18'],  req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','12x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','1x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','27x) 10" Metal L-Bracket (WHT)'] },
  { key:'c11', name:'C-11', sqm:'8m²', count:1, renders: ['c11-0903'], drawings: ['block-c-dwg-19'],  req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light'] },
  { key:'c12', name:'C-12', sqm:'8m²', count:1, renders: ['c12-0903'], drawings: ['block-c-dwg-20'],  req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','5x) 1700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','20x) 10" Metal L-Bracket (WHT)'] },
  { key:'c13', name:'C-13', sqm:'8+18m²', count:1, renders: ['c13-0903'], drawings: ['block-c-dwg-21'],  req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light'] },
  { key:'c14', name:'C-14', sqm:'8m²', count:1, renders: ['c-14-0903'], drawings: ['block-c-dwg-22'], req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light'] },
];
const ZONE_D_TIER = [
  { key:'d01', name:'D-01', sqm:'14m²', count:1, renders: ['d01-0903'], drawings: ['supplier-display-dwg-2', 'block-d-dwg-11'], req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','4× LED arm light','2x) 900 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','3x) 1000 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','1x) 1950 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','14x) 10" Metal L-Bracket (WHT)','1x) Display Shelving — 1452W×1700H×440D, Curved, Formica (WHT)'] },
  { key:'d02', name:'D-02', sqm:'8m²', count:1, renders: ['d02-0903'], drawings: ['block-d-dwg-12'],  req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','1x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','1x) 900 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','1x) 1350 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','3x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','16x) 10" Metal L-Bracket (WHT)'] },
  { key:'d03', name:'D-03', sqm:'8m²', count:1, renders: ['d03-0903'], drawings: ['block-d-dwg-13'],  req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','1x) 1350 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','3x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','12x) 10" Metal L-Bracket (WHT)'] },
  { key:'d04', name:'D-04', sqm:'8m²', count:1, renders: ['d04-0903'], drawings: ['block-d-dwg-14'],  req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','3x) 1350 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','1x) 1800 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','13x) 10" Metal L-Bracket (WHT)'] },
  { key:'d05', name:'D-05', sqm:'8m²', count:1, renders: ['d05-0903'], drawings: ['block-d-dwg-15'],  req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light'] },
  { key:'d06', name:'D-06', sqm:'8m²', count:1, renders: ['d06-0903'], drawings: ['block-d-dwg-16'],  req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','1x) 1350 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','2x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','1x) 1800 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','13x) 10" Metal L-Bracket (WHT)'] },
  { key:'d07', name:'D-07', sqm:'8m²', count:1, renders: ['d07-0903'], drawings: ['block-d-dwg-17'],  req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light'] },
  { key:'d08', name:'D-08', sqm:'8m²', count:1, drawings: ['block-d-dwg-18'],  renders: ['d-08-0903'], req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light'] },
  { key:'d09', name:'D-09', sqm:'8m²', count:1, renders: ['d09-0903'], drawings: ['block-d-dwg-19'],  req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','7x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','4x) 900 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','22x) 10" Metal L-Bracket (WHT)'] },
  { key:'d10', name:'D-10', sqm:'10m²', count:1, renders: ['d10-0903'], drawings: ['block-d-dwg-20'],  req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','2x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','2x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','2x) 1400 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','16x) 10" Metal L-Bracket (WHT)'] },
];
const ZONE_E_TIER = [
  { key:'e01', name:'E-01', sqm:'8m²', count:1, renders: ['e01-0903'], drawings: ['block-e-dwg-7'],  req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','1x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','1x) 900 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','1x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','7x) 10" Metal L-Bracket (WHT)','1× 4\'-6" Clothes Rack','1× 5\'-0" Clothes Rack'] },
  { key:'e02', name:'E-02', sqm:'8m²', count:1, renders: ['e02-0903'], drawings: ['block-e-dwg-8'],  req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light'] },
  { key:'e03', name:'E-03', sqm:'8m²', count:1, renders: ['e03-0903'], drawings: ['block-e-dwg-9'],  req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','8x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','24x) 10" Metal L-Bracket (WHT)'] },
  { key:'e04', name:'E-04', sqm:'8m²', count:1, renders: ['e04-0903'], drawings: ['block-e-dwg-10'],  req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','6x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','12x) 10" Metal L-Bracket (WHT)'] },
  { key:'e05', name:'E-05', sqm:'8m²', count:1, renders: ['e05-0903'], drawings: ['block-e-dwg-11'],  req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','2× 5\'-0" Clothes Rack','4× 12" Rod for Clothes, Wall Mount'] },
  { key:'e06', name:'E-06', sqm:'8m²', count:1, renders: ['e06-0903'], drawings: ['supplier-display-dwg-3', 'block-e-dwg-12'], req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','1x) Display Case — 1902W×2092H×150D, Formica (WHT)'] },
  { key:'e07', name:'E-07', sqm:'8m²', count:1, renders: ['e07-0903'], drawings: ['block-e-dwg-13'],  req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','2x) 900 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','3x) 1000 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','10x) 10" Metal L-Bracket (WHT)','11× Hat/Coat Hook'] },
  { key:'e08', name:'E-08', sqm:'8m²', count:1, renders: ['e08-0903'], drawings: ['block-e-dwg-14'],  req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','8x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','6x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','28x) 10" Metal L-Bracket (WHT)'] },
];
const ZONE_F_TIER = [
...
const ZONE_GB_TIER = [
  ...
  { key:'pk', name:'GB-Pakistan', sqm:'4m²', count:10, req: ['Grey carpet', '2× LED arm light'] },
...
ZONES: [
  ...
  { name: 'Keynote Hall', owner: '', status: 'Approved', img: 'keynote-dark', renders: ['keynote-dark', 'keynote-plan'], scope: 'Carpet removed. All by Youngs / Client.', flag: '⚠ Carpet removed', blocking: true, req: ['All other items — by Youngs / Client'] },
  { name: 'AMA / Influencer Hub', owner: '', status: 'Approved', img: 'ama-hub-render-1', renders: ['ama-hub-render-1'], scope: 'YOUNGS X JOHNATHAN — Banner ×6, Stage, Furniture by Youngs', flag: 'YOUNGS X JOHNATHAN', req: [] },

  { name: 'Match Meeting', owner: '', status: 'Approved', img: 'match-meeting-render-1', renders: ['match-meeting-render-1', 'match-meeting-render-2'], scope: 'YOUNGS X JOHNATHAN — Furniture by Youngs', req: [] },
  { name: 'Mini Panel', owner: '', status: 'Approved', img: 'mini-panel-render-1', renders: ['mini-panel-render-1', 'mini-panel-render-2'], scope: 'YOUNGS X JOHNATHAN — Mini Panel ×2, LED 4×2.5m, Banner ×2 each, Stage, Furniture by Youngs', flag: 'YOUNGS X JOHNATHAN', req: [] },
  ...
  { name: 'Supplier Non-A200 — Block F', owner: 'Siyu', status: 'Approved', img: 'zone-f-map-0825', renders: ['zone-f-map-0825'], drawings: ['block-f-dwg-1', 'block-f-dwg-2', 'block-f-dwg-3'], scope: 'F-01 ~ F-21. 11×6m² + 8×8m² + 2×14m² = 158m². YOUNGS Pop Up. AMG provide counter + TV + lighting + bracket.', flag: '21 booths · 21 std counters · 11/8/2',
    req: ['21× Std Counter — 990W×1000H×495D, Formica White, Lockable Door+Shelf', '21× 42" TV + Media Player + HDMI Cable + Floor Stand', '21× Grey carpet (≈1738 sqft)', '46× LED Arm Light', '26× Popup Bracket for PVC Graphic'], tiers: ZONE_F_TIER, units: makeTieredUnits('zone-f', ZONE_F_TIER, i => BOOTH_LABELS.f[i-1], n => [`f-${String(n).padStart(2,'0')}-0903`, `f-${String(n).padStart(2,'0')}-layout`]) },
  { name: 'Supplier Non-A200 — Block G', owner: 'Siyu', status: 'Approved', img: 'zone-g-map-0825', renders: ['zone-g-map-0825'], drawings: ['block-g-dwg-1', 'block-g-dwg-2'], scope: 'G-01 ~ G-11. 9×8m² + 2×14m². YOUNGS Pop Up. AMG provide counter + TV + lighting + bracket.', flag: '11 booths · 11 std counters · 9/2',
    req: ['11× Std Counter — 990W×1000H×495D, Formica White, Lockable Door+Shelf', '11× 42" TV + Media Player + HDMI Cable + Floor Stand', '11× Grey carpet (≈1100 sqft)', '26× LED Arm Light', '22× Popup Bracket for PVC Graphic'], tiers: ZONE_G_TIER, units: makeTieredUnits('zone-g', ZONE_G_TIER, i => BOOTH_LABELS.g[i-1], n => [`g-${String(n).padStart(2,'0')}-0903`, `g-${String(n).padStart(2,'0')}-layout`]) },
  ...
  { name: 'National Pavilion', owner: 'Siyu', status: 'Approved', img: 'national-gb-map', renders: ['national-gb-map'], drawings: ['national-dwg-1', 'national-dwg-2'], scope: 'GB-01 ~ GB-44 (42 booths, GB-25 withdrew). AMG provide carpet + LED arm light only. 3 groups: GB-US×19, GB-Pakistan×10, GB-Others×14.', flag: '42 booths · carpet + lights only',
    req: ['42× Carpet (≈1890 sqft)', '84× LED arm light'], tiers: ZONE_GB_TIER, units: makeTieredUnits('gb', ZONE_GB_TIER, i => BOOTH_LABELS.gb[i-1], n => [`${BOOTH_LABELS.gb[n-1].split(' ')[0].toLowerCase()}-0903`]) },
