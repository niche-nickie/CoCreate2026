...
ZONES: [
  ...
  { name: 'Supplier A200 — Zone A', owner: 'Jin & Chris', status: 'In Review', img: 'supplier-a200', renders: ['supplier-a200-2', 'supplier-a200-3'], drawings: ['supplier-a200-dwg-1', 'supplier-a200-dwg-2'], scope: 'A-01 ~ A-09. 9× 8sqm. Wooden backdrop (4×2.5mH) + 42" TV + Std Counter + Grey carpet. A200 standard build.', flag: '9× 8sqm · 9 std counters',
    req: ['Wooden backdrop (4×2.5mH)', '42" TV', 'Std Counter', 'Grey carpet', 'Furniture (by Youngs)'] },
  { name: 'Supplier A200 — Zone B', owner: 'Jin & Chris', status: 'In Review', img: 'supplier-a200', renders: ['supplier-a200-2', 'supplier-a200-3'], drawings: ['supplier-a200-dwg-1', 'supplier-a200-dwg-2'], scope: 'B-01 ~ B-08. 8× 8sqm. Wooden backdrop (4×2.5mH) + 42" TV + Std Counter + Grey carpet. A200 standard build.', flag: '8× 8sqm · 8 std counters',
    req: ['Wooden backdrop (4×2.5mH)', '42" TV', 'Std Counter', 'Grey carpet', 'Furniture (by Youngs)'] },
  { name: 'Supplier A200 — Zone C', owner: 'Jin & Chris', status: 'In Review', img: 'supplier-a200', renders: ['supplier-a200-2', 'supplier-a200-3'], drawings: ['supplier-a200-dwg-1', 'supplier-a200-dwg-2'], scope: 'C-01 ~ C-11. 10× 8sqm + 1× 18sqm. Wooden backdrop (4×2.5mH) + 42" TV + Std Counter + Grey carpet. A200 standard build.', flag: '10× 8sqm + 1× 18sqm · 11 std counters',
    req: ['Wooden backdrop (4×2.5mH)', '42" TV', 'Std Counter', 'Grey carpet', 'Furniture (by Youngs)'] },
  { name: 'Supplier A200 — Zone D', owner: 'Jin & Chris', status: 'In Review', img: 'supplier-a200', renders: ['supplier-a200-2', 'supplier-a200-3'], drawings: ['supplier-a200-dwg-1', 'supplier-a200-dwg-2'], scope: 'D-01 ~ D-10. 8/14/8+2sqm mixed. Wooden backdrop (4×2.5mH) + 42" TV + Std Counter + Grey carpet. A200 standard build.', flag: '10× mixed · 10 std counters',
    req: ['Wooden backdrop (4×2.5mH)', '42" TV', 'Std Counter', 'Grey carpet', 'Furniture (by Youngs)'] },
  { name: 'Supplier A200 — Zone E', owner: 'Jin & Chris', status: 'In Review', img: 'supplier-a200', renders: ['supplier-a200-2', 'supplier-a200-3'], drawings: ['supplier-a200-dwg-1', 'supplier-a200-dwg-2'], scope: 'E-01 ~ E-08. 8× 8sqm. Wooden backdrop (4×2.5mH) + 42" TV + Std Counter + Grey carpet. A200 standard build.', flag: '8× 8sqm · 8 std counters',
    req: ['Wooden backdrop (4×2.5mH)', '42" TV', 'Std Counter', 'Grey carpet', 'Furniture (by Youngs)'] },
  { name: 'Supplier Non-A200 — Zone F', owner: 'Jin & Chris', status: 'In Review', img: 'supplier-nona200', renders: ['supplier-nona200-2', 'supplier-nona200-3', 'supplier-nona200-4'], drawings: ['supplier-nona200-dwg-1', 'supplier-nona200-dwg-2', 'supplier-nona200-dwg-3'], scope: 'F-01 ~ F-21. 4/6/8/14sqm mixed. 快幕秀 quick-pop backdrop + 42" TV + Fabric display + shelving (Youngs).', flag: '21× mixed · 21 std counters',
    req: ['快幕秀 quick-pop backdrop', '42" TV', 'Fabric display + shelving (by Youngs)'] },
