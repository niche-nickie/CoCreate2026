...
ZONES: [
  ...
  { name: 'Podcast', owner: 'Iris', status: 'In Review', img: 'podcast-render-1', renders: ['podcast-render-1', 'podcast-render-2'], scope: 'Std Glass Panel, Vinyl, Lightbox, Custom glass panel, Furniture by Youngs', flag: 'YOUNGS', req: [] },
