...
ZONES: [
  ...
  { name: 'Chongqing Pavilion', owner: 'Iris', status: 'In Review', img: 'chongqing-v2-2', renders: ['chongqing-v2-2'], drawings: ['chongqing-dwg-3'], scope: 'AMG shop drawings A.2–A.4 (JP, RENT). 196m² (14×14m). Central: LED Lighting Structure 1200mm dia×3450mm H + 36× LED strips + 4× Display Stands (BLK Formica). Perimeter: 3× Std No Skin Panels 990×2413 + 42" TV + stand wall mount + Counter. 4× 9sqm booths. Hanging Sign 12\' dia double-sided (⚠ rigger). Floor Trim 260ft.', flag: '196m² · 4 booths / ⚠ Hanging banner = rigger required',
    req: ['1× LED Lighting Structure — 1200mm dia×3450mm H, 36× Round LED Strips', '2× Wooden Base/Top — 1200mm dia×100mm H, Formica Black (909-58)', '4× Display Stand — 1000W×650H×700D, Formica Black, LED Strip', '3× Std No Skin Panel — 990W×2413H×100D', '1× Std No Skin Panel — 495W×2413H×100D', '1× Std Counter — 495W×1000H×495D, Formica Black', '1× Hanging Sign — 12\' dia × 2.5\' H, Double-Sided (⚠ rigger)', '1× 42" TV + stand + Media Player (central)', '4× 42" TV wall mount + Media Player (4 booths)', '1× Fabric Graphic — 2966×2409mm, RX-101 Channel 36ft', '260ft Floor Trim', '4× 9sqm Booths, Black+Orange Carpet'] },
