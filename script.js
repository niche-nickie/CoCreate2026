...
ZONES: [
  ...
  { name: 'Supplier A200 — Block A', owner: 'Jin', status: 'Approved', img: 'zone-a-map-0825b', renders: ['zone-a-map-0825b', 'block-a-graphic-final-1', 'block-a-graphic-final-2'], drawings: [], scope: 'A-01 ~ A-09. 9× 8sqm. Wooden backdrop (4×2.5mH) + 42" TV + floor stand + Media Player + Std Counter + Grey carpet + AMG provide shelf & L-bracket.', flag: '9× 8sqm · 8 std counters · AMG shelf',
    req: ['8× Wooden backdrop (4×2.5mH)', '8× 42" TV + floor stand + Media Player', '8× Std Counter — 990W×1000H×495D, Formica White', '9× Grey carpet (≈792 sqft)', '16× LED arm light', '3× Metal Panel Footing', '— AMG Shelf —', '27× 700mm shelf, Formica (WHT) (23× @300D + 4× @400D A-08)', '4× 900mm shelf, Formica (WHT) (4× @400D A-02)', '3× 1500mm shelf, Formica (WHT)', '73× 450mm shelf, Formica (WHT)', '213× 10" Metal L-Bracket (WHT)', '— YOUNGS —', '8× Furniture', '2× Wire Grid 550×1100×50 (A-04 only)'], tiers: ZONE_A_TIER, units: makeTieredUnits('zone-a', ZONE_A_TIER, i => BOOTH_LABELS.a[i-1], n => [`a-${String(n).padStart(2,'0')}-0829`]) },
  { name: 'Supplier A200 — Block B', owner: 'Jin', status: 'Approved', img: 'zone-b-map-0825', renders: ['zone-b-map-0825', 'block-b-graphic-final-1', 'block-b-graphic-final-2'], drawings: [], scope: 'B-01 ~ B-07. 5×8m² + 1×12m² + 1×16m². Wooden backdrop (4×2.5mH) + 42" TV + floor stand + Media Player + Std Counter + Grey carpet. A200 standard build.', flag: '7 booths · 7 std counters · 5×8 + 12 + 16m²',
    req: ['7× Wooden backdrop (4×2.5mH)', '7× 42" TV + floor stand + Media Player', '7× Std Counter — 990W×1000H×495D, Formica White', '7× Grey carpet (≈748 sqft)', '14× LED arm light', '4× Metal Panel Footing', '— YOUNGS —', '7× Furniture'], tiers: ZONE_B_TIER, units: makeTieredUnits('zone-b', ZONE_B_TIER, i => BOOTH_LABELS.b[i-1], n => [`b-${String(n).padStart(2,'0')}-0829`]) },
  ...
  { name: 'Supplier Non-A200 — Block F', owner: 'Iris', status: 'Approved', img: 'zone-f-map-0825', renders: ['zone-f-map-0825'], drawings: [], scope: 'F-01 ~ F-21. 11×6m² + 8×8m² + 2×14m² = 158m². YOUNGS Pop Up. AMG provide counter + TV + lighting + bracket.', flag: '21 booths · 21 std counters · 11/8/2',
    req: ['21× Std Counter — 990W×1000H×495D, Formica White, Lockable Door+Shelf', '21× 42" TV + Media Player + HDMI Cable + Floor Stand', '21× Grey carpet (≈1738 sqft)', '46× LED Arm Light', '26× Popup Bracket for PVC Graphic', '— YOUNGS —', 'Pop Up', 'Displays and shelvings'], tiers: ZONE_F_TIER, units: makeTieredUnits('zone-f', ZONE_F_TIER, i => BOOTH_LABELS.f[i-1], n => [`f-${String(n).padStart(2,'0')}-0829`]) },
  { name: 'Supplier Non-A200 — Block G', owner: 'Iris', status: 'TBD', img: 'zone-g-map-0825', renders: ['zone-g-map-0825'], drawings: [], scope: 'G-01 ~ G-11. 9×8m² + 2×14m². YOUNGS Pop Up. AMG provide counter + TV + lighting + bracket.', flag: '11 booths · 11 std counters · 9/2',
    req: ['11× Std Counter — 990W×1000H×495D, Formica White, Lockable Door+Shelf', '11× 42" TV + Media Player + HDMI Cable + Floor Stand', '11× Grey carpet (≈1100 sqft)', '26× LED Arm Light', '22× Popup Bracket for PVC Graphic', '— YOUNGS —', 'Pop Up', 'Displays and shelvings'], tiers: ZONE_G_TIER, units: makeTieredUnits('zone-g', ZONE_G_TIER, i => BOOTH_LABELS.g[i-1], n => [`g-${String(n).padStart(2,'0')}-0829`]) },
