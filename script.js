...
const ZONE_A_TIER = [
  ...
  { key:'a02', name:'A-02', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','4x) 900 (W)*18 (H)*400 (D), Shelf, Formica (WHT)','9x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','26x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  ...
  { key:'a05', name:'A-05', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','9x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','26x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
...
const ZONE_F_TIER = [
  ...
  { key:'md', name:'Booth', sqm:'8m²', count:8, req: ['42" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','4× LED arm light','— YOUNGS —','Pop Up','Displays and shelvings'] },
...
const ZONE_G_TIER = [
  { key:'sm', name:'Booth', sqm:'6m²', count:9, req: ['42" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Pop Up','Displays and shelvings'] },
  { key:'lg', name:'Booth', sqm:'12m²', count:2, req: ['42" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','4× LED arm light','— YOUNGS —','Pop Up','Displays and shelvings'] },
];
const ZONE_CQ_TIER = [
  { key:'cq1', name:'CQ-1', sqm:'9m²', count:1, req: ['1× Std No Skin Panel — 3000W×2413H×500D','1× Std Counter — 950W×1000H×495D, Formica Black','1× 42" TV wall mount + Media Player','1× Fabric Graphic — 2966×2409mm, RX-101 Channel 9ft','Black+Orange Carpet'] },
  { key:'cq2', name:'CQ-2', sqm:'9m²', count:1, req: ['1× Std No Skin Panel — 3000W×2413H×500D','1× Std Counter — 950W×1000H×495D, Formica Black','1× 42" TV wall mount + Media Player','1× Fabric Graphic — 2966×2409mm, RX-101 Channel 9ft','Black+Orange Carpet'] },
  { key:'cq3', name:'CQ-3', sqm:'9m²', count:1, req: ['1× Std No Skin Panel — 3000W×2413H×500D','1× Std Counter — 950W×1000H×495D, Formica Black','1× 42" TV wall mount + Media Player','1× Fabric Graphic — 2966×2409mm, RX-101 Channel 9ft','Black+Orange Carpet'] },
  { key:'cq4', name:'CQ-4', sqm:'9m²', count:1, req: ['1× Std No Skin Panel — 3000W×2413H×500D','1× Std Counter — 950W×1000H×495D, Formica Black','1× 42" TV wall mount + Media Player','1× Fabric Graphic — 2966×2409mm, RX-101 Channel 9ft','Black+Orange Carpet'] },
];
...
ZONES: [
  ...
  { name: 'Sponsor Booths 13+1', owner: 'Jin & Chris', status: 'Approved', img: 'sponsor-booths', renders: ['sponsor-booths-2', 'sponsor-booths-3', 'sponsor-booths-4', 'sponsor-booths-5'], drawings: ['sponsor-dwg-1', 'sponsor-dwg-2', 'sponsor-dwg-3', 'sponsor-dwg-4'], scope: 'AMG shop drawings A.2–A.5 (JP, RENT). 4 tiers: Community 6m²×7 (Std Counter + 2× LED), Associate 9m²×2 (+42" TV + stand + Media Player + 4× LED), Executive 15m²×2 (+6× LED), Premier 20m²×1 (L-shaped wall + Custom Counter + 42" wall-mount).', flag: '13+1 booths',
    req: ['13× Std Counter — 990W×1000H×495D, Formica White', '1× Custom Counter (Premier, wooden joinery)', '13× 42" TV + stand + Media Player', '1× 42" TV wall mount + Media Player (Premier)', 'LED arm light (數量 TBD)', '— YOUNGS —', 'Furniture + fabric display'],
    tiers: SPONSOR_TIERS,
