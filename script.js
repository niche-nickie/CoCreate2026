...
ZONES: [
  ...
  { name: 'Next-Gen Sourcing + AI', owner: 'Ari', status: 'TBD', img: 'nextgen-1', renders: ['nextgen-1', 'nextgen-2'], scope: 'Youngs proposal received 8/10. Design under review.', flag: '⚠ Blocking engineering', blocking: true, req: [] },
  { name: 'Buyer Story', owner: 'Ari', status: 'Quoted', img: 'buyer-story-v2-1', renders: [...gallery('buyer-story-v2', 5)], scope: 'Youngs provide structure. AMG build + 1× 42" TV + stand.', flag: '⚠ Youngs structure · AMG build + TV',
