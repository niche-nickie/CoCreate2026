...
ZONES: [
  ...
  { name: 'Supplier Non-A200 — Block G', owner: 'Jin & Chris', status: 'TBD', img: 'zone-g-map', renders: ['zone-g-map'], drawings: [], scope: 'G-01 ~ G-11. 9×8m² + 2×14m². YOUNGS Pop Up. AMG provide counter + TV + lighting + bracket.', flag: '11 booths · 11 std counters · 9/2',
  ...
  { name: 'National Pavilion', owner: 'Iris', status: 'In Review', img: 'national-v2-2', renders: ['national-v2-2'], drawings: ['national-dwg-1', 'national-dwg-3'], scope: 'GB-01 ~ GB-41 (41 booths). AMG provide carpet + LED arm light only. 3 groups: GB-US×20, GB-Pakistan×11, GB-Others×10.', flag: '41 booths · carpet + lights only',
    req: ['41× Carpet', '82× LED arm light'], tiers: ZONE_GB_TIER, units: makeTieredUnits('gb', ZONE_GB_TIER, i => BOOTH_LABELS.gb[i-1]) },
