...
ZONES: [
  ...
  { name: 'Sponsor Booths 15+1', owner: 'Jin & Chris', status: 'Approved', img: 'sponsor-booths', renders: ['sponsor-booths-2', 'sponsor-booths-3', 'sponsor-booths-4', 'sponsor-booths-5'], drawings: ['sponsor-dwg-1', 'sponsor-dwg-2', 'sponsor-dwg-3', 'sponsor-dwg-4'], scope: 'AMG shop drawings A.2–A.5 (JP, RENT). 4 tiers: Community 8×8ft×9 (6m², Std Counter + 2× LED), Associate 10×10ft×3 (9m², +42" TV + stand + Media Player + 4× LED), Executive 10×15ft×2 (15m², +6× LED), Premier 10×20ft×1 (20m², L-shaped wall + Custom Counter + 42" wall-mount). 另 1× 10×20ft 空地 (自帶展台, AMG 不提供).', flag: '15+1 booths · 1× 空地',
    req: ['14× Std Counter — 990W×1000H×495D, Formica White', '1× Custom Counter — 1800W×500H×1000D, wooden joinery (Premier)', '5× 42" TV + stand + Media Player', '1× 42" TV wall mount + Media Player (Premier)', '15× Grey carpet', '1× L-shaped wall structure (Premier)', '2× Full-height wall graphic, front only (Premier)', 'LED arm light (數量 TBD)', '— YOUNGS —', 'Pop-up display', 'Furniture + fabric display'],
    tiers: SPONSOR_TIERS,
