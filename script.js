...
const SPONSOR_ASSOCIATE_REQ = ['1× Std Counter — 990W×1000H×495D, Formica White', '1× 42" TV + floor stand + Media Player', '4× LED arm light', 'Grey carpet', '— YOUNGS —', 'Pop-up display (3500×2500mm)', 'High table + bar stools ×1 set', 'Furniture + fabric display'];
const SPONSOR_EXECUTIVE_REQ = ['1× Std Counter — 990W×1000H×495D, Formica White', '1× 42" TV + floor stand + Media Player', '6× LED arm light', 'Grey carpet', '— YOUNGS —', 'L-shaped pop-up display (5000×2500mm + 3000×2500mm)', 'High table + bar stools ×2 sets', 'Furniture + fabric display'];
...
const ZONE_A_TIER = [
  { key:'a01', name:'A-01', sqm:'8m²', count:1, drawings: ['block-a-dwg-8'], req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','9x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','26x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'a02', name:'A-02', sqm:'8m²', count:1, drawings: ['block-a-dwg-9'], renders: ['a-02-0829', 'a-02-0829-2', 'a-02-layout'], req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','9x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','26x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'a03', name:'A-03', sqm:'8m²', count:1, drawings: ['block-a-dwg-10'], req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','7x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','26x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'a04', name:'A-04', sqm:'8m²', count:1, drawings: ['block-a-dwg-11'], req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','3x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','9x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','24x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture','2× Wire Grid 550×1100×50 (Youngs)'] },
  { key:'a05', name:'A-05', sqm:'8m²', count:1, drawings: ['block-a-dwg-12'], renders: ['a-05-0829', 'a-05-0829-2', 'a-05-layout'], req: ['Grey carpet'] },
  { key:'a06', name:'A-06', sqm:'8m²', count:1, drawings: ['block-a-dwg-13'], req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','10x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','28x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'a07', name:'A-07', sqm:'8m²', count:1, drawings: ['block-a-dwg-14'], req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','9x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','26x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'a08', name:'A-08', sqm:'8m²', count:1, drawings: ['block-a-dwg-15'], req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*400 (D), Shelf, Formica (WHT)','11x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','30x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'a09', name:'A-09', sqm:'8m²', count:1, drawings: ['block-a-dwg-16'], req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','3x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','9x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','27x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
];
const ZONE_B_TIER = [
  { key:'b01', name:'B-01', sqm:'8m²', count:1, drawings: ['block-b-dwg-11'],  req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'b02', name:'B-02', sqm:'8m²', count:1, drawings: ['block-b-dwg-9'],  renders: ['b-02-0829', 'b-02-0829-2', 'b-02-layout'], req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'b03', name:'B-03', sqm:'8m²', count:1, drawings: ['block-b-dwg-9'],  req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'b04', name:'B-04', sqm:'8m²', count:1, drawings: ['block-b-dwg-10'],  req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'b05', name:'B-05', sqm:'16m²', count:1, drawings: ['block-b-dwg-10'],  req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'b06', name:'B-06', sqm:'12m²', count:1, drawings: ['block-b-dwg-11'],  req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'b07', name:'B-07', sqm:'8m²', count:1, drawings: ['block-b-dwg-9'],  req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
];
const ZONE_C_TIER = [
  { key:'c01', name:'C-01', sqm:'8m²', count:1, drawings: ['block-c-dwg-9'],  req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'c02', name:'C-02', sqm:'8m²', count:1, drawings: ['block-c-dwg-10'],  req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','10x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','20x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'c03', name:'C-03', sqm:'8m²', count:1, drawings: ['block-c-dwg-11'],  req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','2x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','4x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'c04', name:'C-04', sqm:'8m²', count:1, drawings: ['block-c-dwg-12'],  req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','2x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','6x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'c05', name:'C-05', sqm:'8m²', count:1, drawings: ['block-c-dwg-13'],  req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','5x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','15x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'c06', name:'C-06', sqm:'8m²', count:1, drawings: ['block-c-dwg-14'],  req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','8x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'c07', name:'C-07', sqm:'8m²', count:1, drawings: ['block-c-dwg-15'],  req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','6x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','18x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'c08', name:'C-08', sqm:'8m²', count:1, drawings: ['block-c-dwg-16'],  req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','2x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','14x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'c09', name:'C-09', sqm:'14m²', count:1, drawings: ['supplier-display-dwg-1', 'block-c-dwg-17'], req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','4× LED arm light','1x) Display Shelving — 1452W×1700H×440D, Curved, Formica (WHT)','— YOUNGS —','Furniture'] },
  { key:'c10', name:'C-10', sqm:'8m²', count:1, drawings: ['block-c-dwg-18'],  req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','12x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','1x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','27x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'c11', name:'C-11', sqm:'8m²', count:1, drawings: ['block-c-dwg-19'],  req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'c12', name:'C-12', sqm:'8m²', count:1, drawings: ['block-c-dwg-20'],  req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','5x) 1700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','20x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'c13', name:'C-13', sqm:'8+18m²', count:1, drawings: ['block-c-dwg-21'],  req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'c14', name:'C-14', sqm:'8m²', count:1, renders: ['c14-render-1'], req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
];
const ZONE_D_TIER = [
  { key:'d01', name:'D-01', sqm:'14m²', count:1, drawings: ['supplier-display-dwg-2', 'block-d-dwg-11'], req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','4× LED arm light','2x) 900 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','3x) 1000 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','1x) 1950 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','14x) 10" Metal L-Bracket (WHT)','1x) Display Shelving — 1452W×1700H×440D, Curved, Formica (WHT)','— YOUNGS —','Furniture'] },
  { key:'d02', name:'D-02', sqm:'8m²', count:1, drawings: ['block-d-dwg-12'],  req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','1x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','1x) 900 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','1x) 1350 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','3x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','16x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'d03', name:'D-03', sqm:'8m²', count:1, drawings: ['block-d-dwg-13'],  req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','1x) 1350 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','3x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','12x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'d04', name:'D-04', sqm:'8m²', count:1, drawings: ['block-d-dwg-14'],  req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','3x) 1350 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','1x) 1800 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','13x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'d05', name:'D-05', sqm:'8m²', count:1, drawings: ['block-d-dwg-15'],  req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'d06', name:'D-06', sqm:'8m²', count:1, drawings: ['block-d-dwg-16'],  req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','1x) 1350 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','2x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','1x) 1800 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','13x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'d07', name:'D-07', sqm:'8m²', count:1, drawings: ['block-d-dwg-17'],  req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'d08', name:'D-08', sqm:'8m²', count:1, drawings: ['block-d-dwg-18'],  renders: ['d08-render-1'], req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'d09', name:'D-09', sqm:'8m²', count:1, drawings: ['block-d-dwg-19'],  req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','7x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','4x) 900 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','22x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'d10', name:'D-10', sqm:'10m²', count:1, drawings: ['block-d-dwg-20'],  req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','2x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','2x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','2x) 1400 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','16x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
];
const ZONE_E_TIER = [
  { key:'e01', name:'E-01', sqm:'8m²', count:1, drawings: ['block-e-dwg-7'],  req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','1x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','1x) 900 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','1x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','7x) 10" Metal L-Bracket (WHT)','1× 4\'-6" Clothes Rack','1× 5\'-0" Clothes Rack','— YOUNGS —','Furniture'] },
  { key:'e02', name:'E-02', sqm:'8m²', count:1, drawings: ['block-e-dwg-8'],  req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
  { key:'e03', name:'E-03', sqm:'8m²', count:1, drawings: ['block-e-dwg-9'],  req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','8x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','24x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  { key:'e04', name:'E-04', sqm:'8m²', count:1, drawings: ['block-e-dwg-10'],  req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','6x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','12x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture','4× Wire Grid 550×1100×50 (Youngs)'] },
  { key:'e05', name:'E-05', sqm:'8m²', count:1, drawings: ['block-e-dwg-11'],  req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','2× 5\'-0" Clothes Rack','4× 12" Rod for Clothes, Wall Mount','— YOUNGS —','Furniture','1× Wire Grid 550×1100×50 (Youngs)'] },
  { key:'e06', name:'E-06', sqm:'8m²', count:1, drawings: ['supplier-display-dwg-3', 'block-e-dwg-12'], req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','1x) Display Case — 1902W×2092H×150D, Formica (WHT)','— YOUNGS —','Furniture'] },
  { key:'e07', name:'E-07', sqm:'8m²', count:1, drawings: ['block-e-dwg-13'],  req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','2x) 900 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','3x) 1000 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','10x) 10" Metal L-Bracket (WHT)','11× Hat/Coat Hook','— YOUNGS —','Furniture'] },
  { key:'e08', name:'E-08', sqm:'8m²', count:1, drawings: ['block-e-dwg-14'],  req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','8x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','6x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','28x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
];
const ZONE_F_TIER = [
  { key:'sm', name:'Booth', sqm:'6m²', count:11, req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Pop Up','Displays and shelvings'] },
  { key:'md', name:'Booth', sqm:'8m²', count:8, req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Pop Up','Displays and shelvings'] },
  { key:'lg', name:'Booth', sqm:'14m²', count:2, req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','4× LED arm light','— YOUNGS —','Pop Up','Displays and shelvings'] },
];
const ZONE_G_TIER = [
  { key:'sm', name:'Booth', sqm:'8m²', count:9, req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Pop Up','Displays and shelvings'] },
  { key:'lg', name:'Booth', sqm:'14m²', count:2, req: ['42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','4× LED arm light','— YOUNGS —','Pop Up','Displays and shelvings'] },
];
const ZONE_CQ_TIER = [
  { key:'cq1', name:'CQ-1', sqm:'9m²', count:1, renders: ['chongqing-0825-5', 'cq-01-layout'], req: ['1× Std No Skin Panel — 3000W×2413H×500D','1× Std Counter — 990W×1000H×495D, Formica Black','1× 42" TV wall mount + Media Player','2× LED arm light','1× Fabric Graphic — 2966×2409mm, RX-101 Channel 9ft','Black+Orange Carpet'] },
  { key:'cq2', name:'CQ-2', sqm:'9m²', count:1, renders: ['chongqing-0825-6', 'cq-02-layout'], req: ['1× Std No Skin Panel — 3000W×2413H×500D','1× Std Counter — 990W×1000H×495D, Formica Black','1× 42" TV wall mount + Media Player','2× LED arm light','1× Fabric Graphic — 2966×2409mm, RX-101 Channel 9ft','Black+Orange Carpet'] },
  { key:'cq3', name:'CQ-3', sqm:'9m²', count:1, renders: ['chongqing-0825-7', 'cq-03-layout'], req: ['1× Std No Skin Panel — 3000W×2413H×500D','1× Std Counter — 990W×1000H×495D, Formica Black','1× 42" TV wall mount + Media Player','2× LED arm light','1× Fabric Graphic — 2966×2409mm, RX-101 Channel 9ft','Black+Orange Carpet'] },
];
...
ZONES: [
  { name: 'Registration', owner: 'Ari', status: 'Approved', img: 'registration-v2-2', renders: ['registration-0825-2'], drawings: ['registration-dwg-3', 'registration-dwg-5', 'registration-dwg-6', 'registration-dwg-7', 'registration-dwg-8', 'registration-dwg-9', 'registration-dwg-10'], scope: 'AMG provide registration backdrop, front and back graphic.column graphics', flag: 'Lobby area',
    req: ['12× Std LED arm light', '1× BO fabric — back wall front (REG-BK-WALL-FRT, 9896×2409, 4/0)', '1× BO fabric — back wall back (REG-BK-WALL-BK, 9896×2409, 4/0)', '1× Curved PVC column cover w/ Velcro (COLUMN-COVER, 4/0)', '— YOUNGS —', '6× 8ft table cloth', '7× stanchion sign support', '28× stanchions'] },
  ...
  { name: 'Next-Gen Sourcing + AI', owner: 'Ari', status: 'Approved', img: 'nextgen-render-1', renders: ['nextgen-render-1', 'nextgen-render-2', 'nextgen-render-3', 'nextgen-render-4', 'nextgen-render-5', 'nextgen-render-6', 'nextgen-render-7', 'nextgen-render-8', 'nextgen-render-9', 'nextgen-render-10', 'nextgen-render-11', 'nextgen-render-12', 'nextgen-render-13', 'nextgen-render-14', 'nextgen-render-15', 'nextgen-render-16', 'nextgen-render-17', 'nextgen-render-18', 'nextgen-render-19', 'nextgen-render-20', 'nextgen-render-21', 'nextgen-render-22'], drawings: ['nextgen-dwg-3', 'nextgen-dwg-5', 'nextgen-dwg-6', 'nextgen-dwg-7', 'nextgen-dwg-8', 'nextgen-dwg-9', 'nextgen-dwg-10', 'nextgen-dwg-11', 'nextgen-dwg-12', 'nextgen-dwg-13', 'nextgen-dwg-14', 'nextgen-dwg-16', 'nextgen-dwg-17', 'nextgen-dwg-18', 'nextgen-dwg-19', 'nextgen-dwg-20', 'nextgen-dwg-21', 'nextgen-dwg-22', 'nextgen-dwg-23', 'nextgen-dwg-24', 'nextgen-dwg-25', 'nextgen-dwg-26', 'nextgen-dwg-27', 'nextgen-dwg-28', 'nextgen-dwg-29', 'nextgen-dwg-30', 'nextgen-dwg-31', 'nextgen-dwg-32', 'nextgen-dwg-33', 'nextgen-dwg-34', 'nextgen-dwg-35', 'nextgen-dwg-36'], scope: 'AMG: Hanging Banners, Std+Custom Wood Panels (double-sided graphic), Floor Vinyl ×3, Custom Wood Display ×4, PVC Cut-outs ×3, Banners ×2, Cut-outs ×5, Tilted Wood Platform, 55" TV ×13, 100" TV ×1, Std Counter (9× 990 Black + 5× 495 Black + 1× 990 White + 1× 495 White + 2× 495 Orange), Tables & Stools, Custom Installation. JT: All Mac. All else by Youngs.', flag: 'Structure confirmed 8/17 — AMG+JT+Youngs',
    req: ['9× Std Counter — 990W×1000H×495D, Formica Black', '5× Std Counter — 495W×1000H×495D, Formica Black', '1× Std Counter — 990W×1000H×495D, Formica White', '1× Std Counter — 495W×1000H×495D, Formica White', '2× Std Counter — 495W×1000H×495D, Formica Orange', '13× 55" TV wall mount', '1× 100" TV wall mount', '1× Gray Carpet — 24000 (W)×12000 (L), 3168 sqft', '— YOUNGS —', '3× Banner w/ Stand', '5× Cut-Out Character', '12× Game Character Platform', '1× Game Display', '6× Meeting Table', '47× Ottoman', '1× Round Ottoman', '2× Pop-Up Display'] },
  ...
  { name: 'Supplier A200 — Block A', owner: 'Jin', status: 'Approved', img: 'zone-a-map-0825b', renders: ['zone-a-map-0825b', 'block-a-graphic-final-1', 'block-a-graphic-final-2'], drawings: ['block-a-dwg-1', 'block-a-dwg-2', 'block-a-dwg-3', 'block-a-dwg-4', 'block-a-dwg-5', 'block-a-dwg-6'], scope: 'A-01 ~ A-09. 9× 8sqm. Wooden backdrop (4×2.5mH) + 42" TV + floor stand + Media Player + Std Counter + Grey carpet + AMG provide shelf & L-bracket.', flag: '9× 8sqm · 8 std counters · AMG shelf',
    req: ['8× 42" TV + floor stand + Media Player', '8× Std Counter — 990W×1000H×495D, Formica White', '9× Grey carpet (≈792 sqft)', '16× LED arm light', '3× Metal Panel Footing', '— AMG Shelf —', '27× 700mm shelf, Formica (WHT) (23× @300D + 4× @400D A-08)', '4× 900mm shelf, Formica (WHT) (4× @400D A-02)', '3× 1500mm shelf, Formica (WHT)', '73× 450mm shelf, Formica (WHT)', '213× 10" Metal L-Bracket (WHT)', '— YOUNGS —', '8× Furniture', '2× Wire Grid 550×1100×50 (A-04 only)'], tiers: ZONE_A_TIER, units: makeTieredUnits('zone-a', ZONE_A_TIER, i => BOOTH_LABELS.a[i-1], n => [`a-${String(n).padStart(2,'0')}-0829`, `a-${String(n).padStart(2,'0')}-layout`]) },
  { name: 'Supplier A200 — Block B', owner: 'Jin', status: 'Approved', img: 'zone-b-map-0825', renders: ['zone-b-map-0825', 'block-b-graphic-final-1', 'block-b-graphic-final-2'], drawings: ['block-b-dwg-1', 'block-b-dwg-2', 'block-b-dwg-3', 'block-b-dwg-4', 'block-b-dwg-5', 'block-b-dwg-6', 'block-b-dwg-7', 'block-b-dwg-8'], scope: 'B-01 ~ B-07. 5×8m² + 1×12m² + 1×16m². Wooden backdrop (4×2.5mH) + 42" TV + floor stand + Media Player + Std Counter + Grey carpet. A200 standard build.', flag: '7 booths · 7 std counters · 5×8 + 12 + 16m²',
    req: ['7× 42" TV + floor stand + Media Player', '7× Std Counter — 990W×1000H×495D, Formica White', '7× Grey carpet (≈748 sqft)', '14× LED arm light', '4× Metal Panel Footing', '— YOUNGS —', '7× Furniture'], tiers: ZONE_B_TIER, units: makeTieredUnits('zone-b', ZONE_B_TIER, i => BOOTH_LABELS.b[i-1], n => [`b-${String(n).padStart(2,'0')}-0829`, `b-${String(n).padStart(2,'0')}-layout`]) },
  { name: 'Supplier A200 — Block C', owner: 'Chris', status: 'Approved', img: 'zone-c-map-0825', renders: ['zone-c-map-0825', 'block-c-graphic-final-1', 'block-c-graphic-final-2', 'block-c-graphic-final-3', 'block-c-graphic-final-4'], drawings: ['block-c-dwg-1', 'block-c-dwg-2', 'block-c-dwg-3', 'block-c-dwg-4', 'block-c-dwg-5', 'block-c-dwg-6', 'block-c-dwg-7', 'block-c-dwg-8', 'block-c-dwg-22'], scope: 'C-01 ~ C-14. 13×8m² + 1×14m² + 18m² extra carpet (C-13). Wooden backdrop (4×2.5mH) + 42" TV + floor stand + Media Player + Std Counter + Grey carpet + AMG provide shelf & L-bracket.', flag: '14 booths · 14 std counters · AMG shelf',
  ...
  { name: 'Supplier A200 — Block E', owner: 'Chris', status: 'Approved', img: 'zone-e-map-0825', renders: ['zone-e-map-0825', 'block-e-graphic-final-1', 'block-e-graphic-final-2'], drawings: ['block-e-dwg-1', 'block-e-dwg-2', 'block-e-dwg-3', 'block-e-dwg-4', 'block-e-dwg-5', 'block-e-dwg-6'], scope: 'E-01 ~ E-08. 8× 8m². Wooden backdrop (4×2.5mH) + 42" TV + floor stand + Media Player + Std Counter + Grey carpet + AMG provide shelf & L-bracket.', flag: '8× 8m² · 8 std counters · AMG shelf',
    req: ['8× 42" TV + floor stand + Media Player', '8× Std Counter — 990W×1000H×495D, Formica White', '8× Grey carpet (≈704 sqft)', '16× LED arm light', '4× Metal Panel Footing', '— AMG Shelf —', '17× 450mm shelf, Formica (WHT)', '16× 700mm shelf, Formica (WHT)', '3× 900mm shelf, Formica (WHT)', '3× 1000mm shelf, Formica (WHT)', '1× 1500mm shelf, Formica (WHT)', '1× Display Case — 1902×2092×150, Formica (WHT) (E-06)', '81× 10" Metal L-Bracket (WHT)', '4× Clothes Rack (1×4\'6" + 3×5\'0")', '4× 12" Rod for Clothes', '11× Hat/Coat Hook', '— YOUNGS —', '8× Furniture', '5× Wire Grid 550×1100×50'], tiers: ZONE_E_TIER, units: makeTieredUnits('zone-e', ZONE_E_TIER, i => BOOTH_LABELS.e[i-1], n => [`e-${String(n).padStart(2,'0')}-0829`, `e-${String(n).padStart(2,'0')}-layout`]) },
  { name: 'Supplier Non-A200 — Block F', owner: 'Iris', status: 'Approved', img: 'zone-f-map-0825', renders: ['zone-f-map-0825'], drawings: ['block-f-dwg-1', 'block-f-dwg-2', 'block-f-dwg-3'], scope: 'F-01 ~ F-21. 11×6m² + 8×8m² + 2×14m² = 158m². YOUNGS Pop Up. AMG provide counter + TV + lighting + bracket.', flag: '21 booths · 21 std counters · 11/8/2',
    req: ['21× Std Counter — 990W×1000H×495D, Formica White, Lockable Door+Shelf', '21× 42" TV + Media Player + HDMI Cable + Floor Stand', '21× Grey carpet (≈1738 sqft)', '46× LED Arm Light', '26× Popup Bracket for PVC Graphic', '— YOUNGS —', 'Pop Up', 'Displays and shelvings'], tiers: ZONE_F_TIER, units: makeTieredUnits('zone-f', ZONE_F_TIER, i => BOOTH_LABELS.f[i-1], n => [`f-${String(n).padStart(2,'0')}-0829`, `f-${String(n).padStart(2,'0')}-layout`]) },
  { name: 'Supplier Non-A200 — Block G', owner: 'Iris', status: 'TBD', img: 'zone-g-map-0825', renders: ['zone-g-map-0825'], drawings: ['block-g-dwg-1', 'block-g-dwg-2'], scope: 'G-01 ~ G-11. 9×8m² + 2×14m². YOUNGS Pop Up. AMG provide counter + TV + lighting + bracket.', flag: '11 booths · 11 std counters · 9/2',
    req: ['11× Std Counter — 990W×1000H×495D, Formica White, Lockable Door+Shelf', '11× 42" TV + Media Player + HDMI Cable + Floor Stand', '11× Grey carpet (≈1100 sqft)', '26× LED Arm Light', '22× Popup Bracket for PVC Graphic', '— YOUNGS —', 'Pop Up', 'Displays and shelvings'], tiers: ZONE_G_TIER, units: makeTieredUnits('zone-g', ZONE_G_TIER, i => BOOTH_LABELS.g[i-1], n => [`g-${String(n).padStart(2,'0')}-0829`, `g-${String(n).padStart(2,'0')}-layout`]) },
  ...
  { name: 'Sponsor Booths 16+1', owner: 'Jin', status: 'Approved', img: 'sponsor-booths-map-0825', renders: ['sponsor-booths-map-0825'], drawings: ['sponsor-dwg-1', 'sponsor-dwg-2', 'sponsor-dwg-3', 'sponsor-dwg-4', 'sponsor-dwg-5', 'sponsor-dwg-6', 'sponsor-dwg-7', 'sponsor-dwg-8'], scope: 'AMG shop drawings A.2–A.5 (JP, RENT). 17 booths (P-01 ~ P-17): 8×8ft ×10, 10×10ft ×3, 10×15ft ×2, 10×20ft ×1 (P-14 empty lot, not provided by AMG).', flag: '16+1 booths · 1× empty lot',
    req: ['15× Std Counter — 990W×1000H×495D, Formica White', '1× Custom Counter — 1800W×500H×1000D, wooden joinery (Premier)', '5× 42" TV + floor stand + Media Player', '1× 42" TV wall mount + Media Player (Premier)', '16× Grey carpet (≈1440 sqft)', '2× Full-height wall graphic, front only (Premier)', '51× LED arm light', '— YOUNGS —', 'Pop-up display', 'Furniture + fabric display'],
    tiers: SPONSOR_TIERS,
    units: makeTieredUnits('sponsor', SPONSOR_TIERS) },
  { name: 'National Pavilion', owner: 'Iris', status: 'In Review', img: 'national-gb-map', renders: ['national-gb-map'], drawings: ['national-dwg-1', 'national-dwg-2'], scope: 'GB-01 ~ GB-44 (42 booths, GB-25 & GB-29 withdrew). AMG provide carpet + LED arm light only. 3 groups: GB-US×19, GB-Pakistan×9, GB-Others×14.', flag: '42 booths · carpet + lights only',
  ...
  { name: 'Podcast', owner: 'Iris', status: 'Approved', img: 'podcast-render-1', renders: ['podcast-0825-2'], drawings: ['podcast-dwg-1', 'podcast-dwg-2', 'podcast-dwg-3', 'podcast-dwg-4', 'podcast-dwg-5', 'podcast-dwg-6', 'podcast-dwg-7', 'podcast-dwg-8', 'podcast-dwg-9', 'podcast-dwg-10', 'podcast-dwg-11', 'podcast-dwg-12', 'podcast-dwg-13'], scope: '5.4×3.4m. Octanorm structure + clear acrylic panels + carpet. Client provides angle tables, chairs, On Air lightbox.', flag: 'OP1 spec A.13 · Client display items',
    req: ['1× Carpet — 5180×3368mm (≈192 sqft)', '4× Vinyl Graphic — 1208×898mm, 4/0 (PD-FRONT-GLASS)', '3× Vinyl Graphic — 1029×898mm, 4/0 (PD-LEFT-GLASS)', '— YOUNGS —', '4× Angle Table', '1× On Air Lightbox', '6× Chair'] },
  { name: 'Creator Market (Muse)', owner: 'Iris', status: 'Approved', img: 'muse-scope-0822-1', renders: ['muse-scope-0822-1', 'muse-scope-0822-2', 'muse-scope-0822-3', 'muse-scope-0822-4', 'muse-scope-0822-5', 'muse-scope-0822-6', 'muse-scope-7', 'muse-scope-8'], drawings: ['muse-dwg-1', 'muse-dwg-2', 'muse-dwg-3', 'muse-dwg-4', 'muse-dwg-5', 'muse-dwg-6', 'muse-dwg-7', 'muse-dwg-8'], scope: 'Muse client design (revised 8/14) · Island + Sponsor. 1× Circular flooring 320sqm. 4× Custom wood frame. 3× PVC graphic. 6× Custom column. 1× Vinyl sticker.', flag: 'Structure confirmed 8/17 · 22 booths (12× 8sqm + 6× 16sqm + 4× 32sqm)',
