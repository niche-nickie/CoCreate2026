...
const IMG_CACHE_BUST = '?v=20260829b';  // bump to bust image CDN cache
...
const ZONE_A_TIER = [
  ...
  { key:'a02', name:'A-02', sqm:'8m²', count:1, renders: ['a-02-0829', 'a-02-0829-2', 'a-02-layout'], req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','4x) 700 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','9x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','26x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
  ...
  { key:'a05', name:'A-05', sqm:'8m²', count:1, renders: ['a-05-0829', 'a-05-0829-2', 'a-05-layout'], req: ['Grey carpet'] },
  ...
  { key:'a09', name:'A-09', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + floor stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','3x) 1500 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','9x) 450 (W)*18 (H)*300 (D), Shelf, Formica (WHT)','27x) 10" Metal L-Bracket (WHT)','— YOUNGS —','Furniture'] },
];
const ZONE_B_TIER = [
...
ZONES: [
  { name: 'Registration', owner: 'Ari', status: 'Approved', img: 'registration-v2-2', renders: ['registration-0825-2'], drawings: ['registration-dwg-1', 'registration-dwg-2', 'registration-dwg-3', 'registration-dwg-4', 'registration-dwg-5', 'registration-dwg-6', 'registration-dwg-7', 'registration-dwg-8', 'registration-dwg-9', 'registration-dwg-10'], scope: 'AMG provide registration backdrop, front and back graphic.column graphics', flag: 'Lobby area',
  ...
  { name: 'Wayfinding System & Promotion Materials', owner: 'Ari', status: 'Approved', img: 'wayfinding-0825-1', renders: ['wayfinding-0825-1', 'wayfinding-render-2', 'wayfinding-render-3'], drawings: ['wayfinding-dwg-1', 'octanorm-dwg-1', 'octanorm-dwg-2', 'octanorm-dwg-3', 'octanorm-dwg-4', 'octanorm-dwg-5', 'octanorm-dwg-6', 'octanorm-dwg-7', 'octanorm-dwg-8'], scope: 'AMG provide. Stand ×5 (70×170cmH) + 100" TV ×2 w/ floor stand + Pop up ×3 (3×6.5ft).', flag: '', req: ['5× Stand — 70×170cmH', '2× 100" TV w/ floor stand', '3× Pop up — 3×6.5ft'] },
  ...
  { name: 'Unboxing Live', owner: 'Charles', status: 'Approved', img: 'unboxing-live-render-1', renders: ['unboxing-live-0825-2'], drawings: ['unboxing-dwg-1', 'unboxing-dwg-2', 'unboxing-dwg-3', 'unboxing-dwg-4', 'unboxing-dwg-5', 'unboxing-dwg-6', 'unboxing-dwg-7', 'unboxing-dwg-8', 'unboxing-dwg-9', 'unboxing-dwg-10', 'unboxing-dwg-11', 'unboxing-dwg-12', 'unboxing-dwg-13', 'unboxing-dwg-14'], scope: 'R4 — Display block ×3, Double-sided Pop-up, 55" TV, Furniture by Youngs, Carpet 5584×5584mm', flag: '⚠ R4 — Pop-up + Display blocks + TV', req: ['1× Custom Display Box #03 — 300W×600H×300D, White Formica', '1× Custom Display Box #04 — 300W×650H×300D, White Formica', '1× Custom Display Box #05 — 300W×450H×300D, White Formica', 'Double-sided Pop-up', '1× 55" TV w/ floor stand', 'Furniture by Youngs', '1× Carpet — 5584 (W)×5584 (L), Finish (Pendent), 343 sqft'] },
  { name: 'Supplier A200 — Block A', owner: 'Jin', status: 'Approved', img: 'zone-a-map-0825b', renders: ['zone-a-map-0825b', 'block-a-graphic-final-1', 'block-a-graphic-final-2'], drawings: ['block-a-dwg-1', 'block-a-dwg-2', 'block-a-dwg-3', 'block-a-dwg-4', 'block-a-dwg-5', 'block-a-dwg-6', 'block-a-dwg-7', 'block-a-dwg-8', 'block-a-dwg-9', 'block-a-dwg-10', 'block-a-dwg-11', 'block-a-dwg-12', 'block-a-dwg-13', 'block-a-dwg-14', 'block-a-dwg-15', 'block-a-dwg-16'], scope: 'A-01 ~ A-09. 9× 8sqm. Wooden backdrop (4×2.5mH) + 42" TV + floor stand + Media Player + Std Counter + Grey carpet + AMG provide shelf & L-bracket.', flag: '9× 8sqm · 8 std counters · AMG shelf',
    req: ['8× Wooden backdrop (4×2.5mH)', '8× 42" TV + floor stand + Media Player', '8× Std Counter — 990W×1000H×495D, Formica White', '9× Grey carpet (≈792 sqft)', '16× LED arm light', '3× Metal Panel Footing', '— AMG Shelf —', '27× 700mm shelf, Formica (WHT) (23× @300D + 4× @400D A-08)', '4× 900mm shelf, Formica (WHT) (4× @400D A-02)', '3× 1500mm shelf, Formica (WHT)', '73× 450mm shelf, Formica (WHT)', '213× 10" Metal L-Bracket (WHT)', '— YOUNGS —', '8× Furniture', '2× Wire Grid 550×1100×50 (A-04 only)'], tiers: ZONE_A_TIER, units: makeTieredUnits('zone-a', ZONE_A_TIER, i => BOOTH_LABELS.a[i-1], n => [`a-${String(n).padStart(2,'0')}-0829`, `a-${String(n).padStart(2,'0')}-layout`]) },
  { name: 'Supplier A200 — Block B', owner: 'Jin', status: 'Approved', img: 'zone-b-map-0825', renders: ['zone-b-map-0825', 'block-b-graphic-final-1', 'block-b-graphic-final-2'], drawings: ['block-b-dwg-1', 'block-b-dwg-2', 'block-b-dwg-3', 'block-b-dwg-4', 'block-b-dwg-5', 'block-b-dwg-6', 'block-b-dwg-7', 'block-b-dwg-8', 'block-b-dwg-9', 'block-b-dwg-10', 'block-b-dwg-11'], scope: 'B-01 ~ B-07. 5×8m² + 1×12m² + 1×16m². Wooden backdrop (4×2.5mH) + 42" TV + floor stand + Media Player + Std Counter + Grey carpet. A200 standard build.', flag: '7 booths · 7 std counters · 5×8 + 12 + 16m²',
    req: ['7× Wooden backdrop (4×2.5mH)', '7× 42" TV + floor stand + Media Player', '7× Std Counter — 990W×1000H×495D, Formica White', '7× Grey carpet (≈748 sqft)', '14× LED arm light', '4× Metal Panel Footing', '— YOUNGS —', '7× Furniture'], tiers: ZONE_B_TIER, units: makeTieredUnits('zone-b', ZONE_B_TIER, i => BOOTH_LABELS.b[i-1], n => [`b-${String(n).padStart(2,'0')}-0829`, `b-${String(n).padStart(2,'0')}-layout`]) },
  { name: 'Supplier A200 — Block C', owner: 'Chris', status: 'Approved', img: 'zone-c-map-0825', renders: ['zone-c-map-0825', 'block-c-graphic-final-1', 'block-c-graphic-final-2', 'block-c-graphic-final-3', 'block-c-graphic-final-4'], drawings: ['block-c-dwg-1', 'block-c-dwg-2', 'block-c-dwg-3', 'block-c-dwg-4', 'block-c-dwg-5', 'block-c-dwg-6', 'block-c-dwg-7', 'block-c-dwg-8', 'block-c-dwg-9', 'block-c-dwg-10', 'block-c-dwg-11', 'block-c-dwg-12', 'block-c-dwg-13', 'block-c-dwg-14', 'block-c-dwg-15', 'block-c-dwg-16', 'block-c-dwg-17', 'block-c-dwg-18', 'block-c-dwg-19', 'block-c-dwg-20', 'block-c-dwg-21', 'block-c-dwg-22'], scope: 'C-01 ~ C-14. 13×8m² + 1×14m² + 18m² extra carpet (C-13). Wooden backdrop (4×2.5mH) + 42" TV + floor stand + Media Player + Std Counter + Grey carpet + AMG provide shelf & L-bracket.', flag: '14 booths · 14 std counters · AMG shelf',
    req: ['14× Wooden backdrop (4×2.5mH)', '14× 42" TV + floor stand + Media Player', '14× Std Counter — 990W×1000H×495D, Formica White', '14× Grey carpet (≈1496 sqft)', '30× LED arm light', '6× Metal Panel Footing', '— AMG Shelf —', '20× 700mm shelf, Formica (WHT)', '12× 450mm shelf, Formica (WHT)', '16× 1500mm shelf, Formica (WHT)', '5× 1700mm shelf, Formica (WHT)', '1× Display Shelving — 1452×1700×440, Curved, Formica (WHT) (C-09)', '132× 10" Metal L-Bracket (WHT)', '— YOUNGS —', '14× Furniture'], tiers: ZONE_C_TIER, units: makeTieredUnits('zone-c', ZONE_C_TIER, i => BOOTH_LABELS.c[i-1], n => [`c-${String(n).padStart(2,'0')}-0829`, `c-${String(n).padStart(2,'0')}-layout`]) },
  { name: 'Supplier A200 — Block D', owner: 'Chris', status: 'Approved', img: 'zone-d-map-0825', renders: ['zone-d-map-0825', 'block-d-graphic-final-1', 'block-d-graphic-final-2'], drawings: ['block-d-dwg-1', 'block-d-dwg-2', 'block-d-dwg-3', 'block-d-dwg-4', 'block-d-dwg-5', 'block-d-dwg-6', 'block-d-dwg-7', 'block-d-dwg-8', 'block-d-dwg-9', 'block-d-dwg-10', 'block-d-dwg-11', 'block-d-dwg-12', 'block-d-dwg-13', 'block-d-dwg-14', 'block-d-dwg-15', 'block-d-dwg-16', 'block-d-dwg-17', 'block-d-dwg-18', 'block-d-dwg-19', 'block-d-dwg-20'], scope: 'D-01 ~ D-10. 1×14m² + 8×8m² + 1×10m² = 88m². Wooden backdrop + TV + Std Counter + Grey carpet + AMG shelf & L-bracket.', flag: '10 booths · 10 std counters · AMG shelf',
    req: ['10× Wooden backdrop (4×2.5mH)', '10× 42" TV + floor stand + Media Player', '10× Std Counter — 990W×1000H×495D, Formica White', '10× Grey carpet (≈968 sqft)', '22× LED arm light', '3× Metal Panel Footing', '— AMG Shelf —', '3× 450mm shelf, Formica (WHT)', '9× 700mm shelf, Formica (WHT)', '7× 900mm shelf, Formica (WHT)', '3× 1000mm shelf, Formica (WHT)', '6× 1350mm shelf, Formica (WHT)', '8× 1500mm shelf, Formica (WHT)', '2× 1800mm shelf, Formica (WHT)', '2× 1400mm shelf, Formica (WHT)', '1× 1950mm shelf, Formica (WHT)', '1× Display Shelving — 1452×1700×440, Curved, Formica (WHT) (D-01)', '106× 10" Metal L-Bracket (WHT)', '— YOUNGS —', '10× Furniture'], tiers: ZONE_D_TIER, units: makeTieredUnits('zone-d', ZONE_D_TIER, i => BOOTH_LABELS.d[i-1], n => [`d-${String(n).padStart(2,'0')}-0829`, `d-${String(n).padStart(2,'0')}-layout`]) },
  ...
  { name: 'Sponsor Booths 16+1', owner: 'Jin', status: 'Approved', img: 'sponsor-booths-map-0825', renders: ['sponsor-booths-map-0825'], drawings: ['sponsor-dwg-1', 'sponsor-dwg-2', 'sponsor-dwg-3', 'sponsor-dwg-4', 'sponsor-dwg-5', 'sponsor-dwg-6', 'sponsor-dwg-7', 'sponsor-dwg-8'], scope: 'AMG shop drawings A.2–A.5 (JP, RENT). 17 booths (P-01 ~ P-17): 8×8ft ×10, 10×10ft ×3, 10×15ft ×2, 10×20ft ×1 (P-14 empty lot, not provided by AMG).', flag: '16+1 booths · 1× empty lot',
    req: ['15× Std Counter — 990W×1000H×495D, Formica White', '1× Custom Counter — 1800W×500H×1000D, wooden joinery (Premier)', '5× 42" TV + floor stand + Media Player', '1× 42" TV wall mount + Media Player (Premier)', '16× Grey carpet (≈1440 sqft)', '1× L-shaped wall structure (Premier)', '2× Full-height wall graphic, front only (Premier)', '51× LED arm light', '— YOUNGS —', 'Pop-up display', 'Furniture + fabric display'],
    tiers: SPONSOR_TIERS,
  ...
  { name: 'Creator Market (Muse)', owner: 'Iris', status: 'Approved', img: 'muse-scope-0822-1', renders: ['muse-scope-0822-1', 'muse-scope-0822-2', 'muse-scope-0822-3', 'muse-scope-0822-4', 'muse-scope-0822-5', 'muse-scope-0822-6', 'muse-scope-7', 'muse-scope-8'], drawings: ['muse-dwg-1', 'muse-dwg-2', 'muse-dwg-3', 'muse-dwg-4', 'muse-dwg-5', 'muse-dwg-6', 'muse-dwg-7', 'muse-dwg-8'], scope: 'Muse client design (revised 8/14) · Island + Sponsor. 1× Circular flooring 320sqm. 4× Custom wood frame. 3× PVC graphic. 6× Custom column. 1× Vinyl sticker.', flag: 'Structure confirmed 8/17 · 22 booths (12× 8sqm + 6× 16sqm + 4× 32sqm)',
    req: ['1× Circular flooring — black/grey/white w/ text (320sqm)', '4× Custom wood frame structure w/ base (open 5 sides, overhead crossbeam for fishing lines)', '3× PVC graphic on both sides', '6× Custom Column (Island)', '3x) Track', '7x) Track Light', '1× Vinyl sticker (Sponsor)'] },
