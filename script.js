...
const ZONE_D_TIER = [
  ...
  { key:'d08', name:'D-08', sqm:'8m²', count:1, req: ['Wooden backdrop (4×2.5mH)','42" TV + stand + Media Player','Std Counter — 990W×1000H×495D, Formica White','Grey carpet','2× LED arm light','— YOUNGS —','Furniture'] },
...
ZONES: [
  { name: 'Registration', owner: 'Ari', status: 'Approved', img: 'registration-v2-2', renders: ['registration-0825-1', 'registration-0825-2', 'registration-0825-3'], drawings: ['registration-dwg-1', 'registration-dwg-2'], scope: 'AMG provide registration backdrop, front and back graphic.column graphics', flag: 'Lobby area',
  ...
  { name: 'Buyer Story', owner: 'Chris', status: 'Approved', img: 'buyer-story-v2-2', renders: ['buyer-story-0825-1', 'buyer-story-0825-2', 'buyer-story-0825-3', 'buyer-story-0825-4', 'buyer-story-0825-5', 'buyer-story-0825-6'], scope: 'Youngs provide structure. AMG build + 1× 42" TV + stand + Media Player.', flag: '⚠ Youngs structure · AMG build + TV',
    req: ['Structure (by Youngs)', 'AMG build', '1× 42" TV + stand + Media Player'] },
  { name: 'Unboxing Live', owner: 'Charles', status: 'Approved', img: 'unboxing-live-render-1', renders: ['unboxing-live-0825-1', 'unboxing-live-0825-2'], scope: 'R4 — Display block ×3, Double-sided Pop-up, 55" TV, Furniture by Youngs, Carpet 5584×5584mm', flag: '⚠ R4 — Pop-up + Display blocks + TV', req: ['1× Custom Display Box #03 — 300W×600H×300D, White Formica', '1× Custom Display Box #04 — 300W×650H×300D, White Formica', '1× Custom Display Box #05 — 300W×450H×300D, White Formica', 'Double-sided Pop-up', '1× 55" TV w/ stand', 'Furniture by Youngs', '1× Carpet — 5584 (W)×5584 (L), Finish (Pendent), 343 sqft'] },
  { name: 'Supplier A200 — Block A', owner: 'Jin', status: 'Approved', img: 'zone-a-map-0825', renders: ['zone-a-map-0825'], drawings: [], scope: 'A-01 ~ A-09. 9× 8sqm. Wooden backdrop (4×2.5mH) + 42" TV + stand + Media Player + Std Counter + Grey carpet + AMG provide shelf & L-bracket.', flag: '9× 8sqm · 8 std counters · AMG shelf',
  ...
  { name: 'Supplier A200 — Block C', owner: 'Chris', status: 'Approved', img: 'zone-c-map-0818', renders: ['zone-c-map-0818'], drawings: [], scope: 'C-01 ~ C-14. 12×8m² + 1×14m² + 1×26m². Wooden backdrop (4×2.5mH) + 42" TV + stand + Media Player + Std Counter + Grey carpet + AMG provide shelf & L-bracket.', flag: '14 booths · 14 std counters · AMG shelf',
    req: ['14× Wooden backdrop (4×2.5mH)', '14× 42" TV + stand + Media Player', '14× Std Counter — 990W×1000H×495D, Formica White', '14× Grey carpet (≈1496 sqft)', '32× LED arm light', '6× Metal Panel Footing', '— AMG Shelf —', '20× 700mm shelf, Formica (WHT)', '12× 450mm shelf, Formica (WHT)', '16× 1500mm shelf, Formica (WHT)', '5× 1700mm shelf, Formica (WHT)', '1× Display Shelving — 1452×1700×440, Curved, Formica (WHT) (C-09)', '132× 10" Metal L-Bracket (WHT)', '— YOUNGS —', '14× Furniture'], tiers: ZONE_C_TIER, units: makeTieredUnits('zone-c', ZONE_C_TIER, i => BOOTH_LABELS.c[i-1], n => [`zone-c-render-${n*2}`, `zone-c-render-${n*2-1}`]) },
  { name: 'Supplier A200 — Block D', owner: 'Chris', status: 'Approved', img: 'zone-d-map-0818', renders: ['zone-d-map-0818'], drawings: [], scope: 'D-01 ~ D-10. 1×14m² + 8×8m² + 1×10m² = 88m². Wooden backdrop + TV + Std Counter + Grey carpet + AMG shelf & L-bracket.', flag: '10 booths · 10 std counters · AMG shelf',
  ...
  { name: 'Supplier A200 — Block E', owner: 'Chris', status: 'Approved', img: 'zone-e-map-0818', renders: ['zone-e-map-0818'], drawings: [], scope: 'E-01 ~ E-08. 8× 8m². Wooden backdrop (4×2.5mH) + 42" TV + stand + Media Player + Std Counter + Grey carpet + AMG provide shelf & L-bracket.', flag: '8× 8m² · 8 std counters · AMG shelf',
  ...
  { name: 'Chongqing Pavilion', owner: 'Chris', status: 'Approved', img: 'chongqing-map', renders: ['chongqing-0825-1', 'chongqing-0825-2', 'chongqing-0825-3', 'chongqing-0825-4', 'chongqing-0825-5', 'chongqing-0825-6', 'chongqing-0825-7'], drawings: ['chongqing-dwg-3'], scope: 'AMG shop drawings A.2–A.4 (JP, RENT). 27m² (3× 9sqm). Central: LED Lighting Structure 1200mm dia×3450mm H + 27× LED strips + 3× Display Stands (BLK Formica). Perimeter: 3× Std No Skin Panels 990×2413 + 42" TV + stand + Media Player wall mount + Counter. Floor Trim 260ft.', flag: '3× 9sqm booths',
  ...
  { name: 'Podcast', owner: 'Iris', status: 'Approved', img: 'podcast-render-1', renders: ['podcast-0825-1', 'podcast-0825-2'], drawings: ['podcast-dwg-1'], scope: '5.4×3.4m. Octanorm structure + clear acrylic panels + carpet. Client provides angle tables, chairs, On Air lightbox.', flag: 'OP1 spec A.13 · Client display items',
  ...
  { name: 'UED Booth', owner: 'Ari', status: 'Approved', img: 'ued-render-1', renders: ['ued-render-1', 'ued-render-2'], drawings: ['ued-dwg-1'], scope: '7×2.2m (15.4m²). Std Panel + Std Counter + 55" TV + LED + RX-101 channels. Flooring ≈169 sqft.', flag: 'Furniture and devices from Youngs',
