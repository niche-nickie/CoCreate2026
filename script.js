...
ZONES: [
  ...
  { name: 'Supplier A200 — Block A', owner: 'Jin & Chris', status: 'Approved', img: 'zone-a-map', renders: ['zone-a-map'], drawings: [], scope: 'A-01 ~ A-09. 9× 8sqm. Wooden backdrop (4×2.5mH) + 42" TV + stand + Media Player + Std Counter + Grey carpet + AMG provide shelf & L-bracket.', flag: '9× 8sqm · 9 std counters · AMG shelf',
    req: ['9× Wooden backdrop (4×2.5mH)', '9× 42" TV + stand + Media Player', '9× Std Counter', '9× Grey carpet (≈792 sqft)', '18× LED arm light', '3× Metal Panel Footing', '— AMG Shelf —', '34× 700mm shelf, Formica (WHT) (4× @400D A-08)', '4× 900mm shelf, Formica (WHT) (4× @400D A-02)', '3× 1500mm shelf, Formica (WHT)', '82× 450mm shelf, Formica (WHT)', '239× 10" Metal L-Bracket (WHT)', '— YOUNGS —', '9× Furniture', '2× Wire Grid 550×1100×50 (A-04 only)'], tiers: ZONE_A_TIER, units: makeTieredUnits('zone-a', ZONE_A_TIER, i => BOOTH_LABELS.a[i-1], n => [`zone-a-render-${n*2}`, `zone-a-render-${n*2-1}`]) },
  ...
  { name: 'Supplier A200 — Block E', owner: 'Jin & Chris', status: 'Approved', img: 'zone-e-map', renders: ['zone-e-map'], drawings: [], scope: 'E-01 ~ E-08. 8× 8m². Wooden backdrop (4×2.5mH) + 42" TV + stand + Media Player + Std Counter + Grey carpet + AMG provide shelf & L-bracket.', flag: '8× 8m² · 8 std counters · AMG shelf',
    req: ['8× Wooden backdrop (4×2.5mH)', '8× 42" TV + stand + Media Player', '8× Std Counter', '8× Grey carpet (≈704 sqft)', '16× LED arm light', '4× Metal Panel Footing', '— AMG Shelf —', '17× 450mm shelf, Formica (WHT)', '20× 700mm shelf, Formica (WHT)', '3× 900mm shelf, Formica (WHT)', '3× 1000mm shelf, Formica (WHT)', '1× 1500mm shelf, Formica (WHT)', '1× Display Case — 1902×2092×150, Formica (WHT) (E-06)', '81× 10" Metal L-Bracket (WHT)', '4× Clothes Rack (1×4\'6" + 3×5\'0")', '4× 12" Rod for Clothes', '11× Hat/Coat Hook', '— YOUNGS —', '8× Furniture', '5× Wire Grid 550×1100×50'], tiers: ZONE_E_TIER, units: makeTieredUnits('zone-e', ZONE_E_TIER, i => BOOTH_LABELS.e[i-1], n => [`zone-e-render-${n*2}`, `zone-e-render-${n*2-1}`]) },
