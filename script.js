...
ZONES: [
  ...
  { name: 'Supplier Non-A200 — Block G', owner: 'Seyu', status: 'Approved', img: 'zone-g-map-0825', renders: ['zone-g-map-0825'], drawings: ['block-g-dwg-1', 'block-g-dwg-2'], scope: 'G-01 ~ G-11. 9×8m² + 2×14m². YOUNGS Pop Up. AMG provide counter + TV + lighting + bracket.', flag: '11 booths · 11 std counters · 9/2',
  ...
  { name: 'National Pavilion', owner: 'Seyu', status: 'Approved', img: 'national-gb-map', renders: ['national-gb-map'], drawings: ['national-dwg-1', 'national-dwg-2'], scope: 'GB-01 ~ GB-44 (42 booths, GB-25 & GB-29 withdrew). AMG provide carpet + LED arm light only. 3 groups: GB-US×19, GB-Pakistan×9, GB-Others×14.', flag: '42 booths · carpet + lights only',
