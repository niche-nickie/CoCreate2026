...
ZONES: [
  ...
  { name: 'Mini Panel', owner: 'Ari', status: 'Quoted', img: 'mini-panel-render-1', renders: ['mini-panel-render-1', 'mini-panel-render-2'], scope: 'YOUNGS X JOHNATHAN — Mini Panel ×2, LED 4×2.5m, Banner ×2 each, Stage, Furniture by Youngs', flag: 'YOUNGS X JOHNATHAN', req: [] },
  { name: 'Core Display', owner: 'Iris', status: 'Quoted', img: 'core-display-v2-2', renders: ['core-display-v2-2'], scope: 'AMG shop drawing A.8 (VB, V0). Custom: 1× Wooden Letters Display 7447×913×260mm (White), 2× Curved Base 1910×306×455mm (Orange), 2× Base 1910×306×455mm (Orange). Client: 3× Character Display (Youngs). Graphics: CD-INFO/LOGO/SIGN vinyls.', flag: 'YOUNGS', req: [] },
