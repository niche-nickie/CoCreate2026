...
ZONES: [
  ...
  { name: 'Supplier A200 — Block A', owner: 'Jin', status: 'Approved', img: 'zone-a-map', renders: ['zone-a-map'], drawings: [], scope: 'A-01 ~ A-09. 9× 8sqm. Wooden backdrop (4×2.5mH) + 42" TV + stand + Media Player + Std Counter + Grey carpet + AMG provide shelf & L-bracket.', flag: '9× 8sqm · 9 std counters · AMG shelf',
  ...
  { name: 'Supplier A200 — Block B', owner: 'Jin', status: 'Approved', img: 'zone-b-map', renders: ['zone-b-map'], drawings: [], scope: 'B-01 ~ B-07. 5×8m² + 1×12m² + 1×16m². Wooden backdrop (4×2.5mH) + 42" TV + stand + Media Player + Std Counter + Grey carpet. A200 standard build.', flag: '7 booths · 7 std counters · 5×8 + 12 + 16m²',
  ...
  { name: 'Supplier A200 — Block C', owner: 'Chris', status: 'Approved', img: 'zone-c-map', renders: ['zone-c-map'], drawings: [], scope: 'C-01 ~ C-13. 11×8m² + 1×14m² + 1×26m². Wooden backdrop (4×2.5mH) + 42" TV + stand + Media Player + Std Counter + Grey carpet + AMG provide shelf & L-bracket.', flag: '13 booths · 13 std counters · AMG shelf',
  ...
  { name: 'Supplier A200 — Block D', owner: 'Chris', status: 'Approved', img: 'zone-d-map', renders: ['zone-d-map'], drawings: [], scope: 'D-01 ~ D-07, D-09 ~ D-10. 1×14m² + 7×8m² + 1×10m² = 80m². Wooden backdrop + TV + Std Counter + Grey carpet + AMG shelf & L-bracket.', flag: '9 booths · 9 std counters · AMG shelf (D-08 removed)',
  ...
  { name: 'Supplier A200 — Block E', owner: 'Charles', status: 'Approved', img: 'zone-e-map', renders: ['zone-e-map'], drawings: [], scope: 'E-01 ~ E-08. 8× 8m². Wooden backdrop (4×2.5mH) + 42" TV + stand + Media Player + Std Counter + Grey carpet + AMG provide shelf & L-bracket.', flag: '8× 8m² · 8 std counters · AMG shelf',
  ...
  { name: 'Supplier Non-A200 — Block F', owner: 'Siyu', status: 'Approved', img: 'zone-f-map', renders: ['zone-f-map'], drawings: [], scope: 'F-01 ~ F-21. 11×6m² + 8×8m² + 2×14m² = 158m². YOUNGS Pop Up. AMG provide counter + TV + lighting + bracket.', flag: '21 booths · 21 std counters · 11/8/2',
  ...
  { name: 'National Pavilion', owner: 'Siyu', status: 'In Review', img: 'national-v2-2', renders: ['national-v2-2'], drawings: ['national-dwg-1', 'national-dwg-3'], scope: 'GB-01 ~ GB-41 (41 booths). AMG provide carpet + LED arm light only. 3 groups: GB-US×20, GB-Pakistan×11, GB-Others×10.', flag: '41 booths · carpet + lights only',
