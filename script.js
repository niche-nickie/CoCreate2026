...
ZONES: [
  ...
  { name: 'Next-Gen Sourcing + AI', owner: 'Ari', status: 'In Review', img: 'nextgen-render-1', renders: ['nextgen-render-1', 'nextgen-render-2', 'nextgen-render-3', 'nextgen-render-4', 'nextgen-render-5', 'nextgen-render-6', 'nextgen-render-7'], scope: 'AMG: Hanging Banners, Std+Custom Wood Panels (double-sided graphic), Floor Vinyl ×3, Custom Wood Display ×4, PVC Cut-outs ×3, Banners ×2, Cut-outs ×5, Tilted Wood Platform, 55" TV ×13, 100" TV ×1, Black Custom Counters ×4, White Std Counter ×1, Orange Counters ×2, Tables & Stools, Custom Installation. JT: All Mac. All else by Youngs.', flag: '⚠ Scope received 8/11 — AMG+JT+Youngs',
    req: ['9× Std Counter — 990W×1000H×495D, Formica Black', '5× Std Counter — 495W×1000H×495D, Formica Black', '1× Std Counter — 990W×1000H×495D, Formica White', '1× Std Counter — 495W×1000H×495D, Formica White', '2× Std Counter — 495W×1000H×495D, Formica Orange', '13× 55" TV wall mount', '1× 100" TV wall mount'] },
  ...
  { name: 'Creator Market (Muse)', owner: 'Iris', status: 'In Review', img: 'muse-scope-2', renders: [...gallery('muse-scope', 9)], drawings: [], scope: 'Muse client design (revised 8/14) · Island + Sponsor. 1× Circular flooring 320sqm. 3× 75" TV. 5× Std Counter — 990W×1000H×495D, Formica White. 4× Custom wood frame. 3× PVC graphic. 6× Custom column. 1× Vinyl sticker. Arm lights — pending JT.', flag: 'Client design · 22 booths (12× 8sqm + 6× 16sqm + 4× 32sqm) · arm light pending',
