...
ZONES: [
  ...
  { name: 'AMA / Influencer Hub', owner: 'Ari', status: 'Quoted', img: 'ama-hub-v2-1', renders: ['ama-hub-v2-1'], scope: 'AVL: Johnathan.', flag: 'Johnathan', req: [] },

  { name: 'Match Meeting', owner: 'Ari', status: 'TBD', img: 'ama-hub-v2-2', renders: ['ama-hub-v2-2'], scope: 'AVL: Johnathan.', flag: 'Johnathan', req: [] },
